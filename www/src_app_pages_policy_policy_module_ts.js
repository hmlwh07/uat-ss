...
/* harmony import */ var _policy_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../policy.service */ 46045);
/* harmony import */ var _policy_const__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./policy.const */ 76175);
...
let PolicyComponent = class PolicyComponent {
    constructor(modalService, prodctService, router, policyService, cdRef, customerService, menuService) {
        ...
        this.ELEMENT_COL = JSON.parse(JSON.stringify(_policy_const__WEBPACK_IMPORTED_MODULE_10__.PolicyCol));
        this.displayedColumns = _policy_const__WEBPACK_IMPORTED_MODULE_10__.PolicyDisplayCol;
    }
    ngOnInit() {
...
PolicyComponent.ctorParameters = () => [
    ...
    { type: _policy_service__WEBPACK_IMPORTED_MODULE_9__.PolicyService },
...
PolicyComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_17__.__decorate)([
