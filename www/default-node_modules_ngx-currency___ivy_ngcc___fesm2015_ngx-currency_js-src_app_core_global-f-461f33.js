...
let GlobalFunctionService = class GlobalFunctionService {
    constructor(numberPipe, alert, exChangeService, motorService) {
        ...
        this.halfOfSumInsuredResult = new rxjs__WEBPACK_IMPORTED_MODULE_4__.BehaviorSubject(null);
        this.snakeSumInsuredResult = new rxjs__WEBPACK_IMPORTED_MODULE_4__.BehaviorSubject(null);
        this.tempFormData = {};
        this.exChange = 1650;
