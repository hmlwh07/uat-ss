...
const API_ADDON_URL = `${_environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.apiUrl}/premiumProductSaleChannel`;
...
let ReportProductSalesChannelPremiumExportService = class ReportProductSalesChannelPremiumExportService extends _app_core_biz_operation_service__WEBPACK_IMPORTED_MODULE_2__.BizOperationService {
...
ReportProductSalesChannelPremiumExportService = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
...
/* harmony import */ var _report_by_product_sales_channel_premium_export_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./report-by-product-sales-channel-premium-export.service */ 54052);
    ...
    generateReportExcel() {
        ...
        for (var i = 0; i < this.dataList.length; i++) {
            ...
            for (var j = 0; j < this.dataList[i].productDataList.length; j++) {
                list.push(this.dataList[i].productDataList[j].totalPreminum);
            }
...
ReportByProductSalesChannelPremiumComponent.ctorParameters = () => [
    ...
    { type: _report_by_product_sales_channel_premium_export_service__WEBPACK_IMPORTED_MODULE_3__.ReportProductSalesChannelPremiumExportService }
];
ReportByProductSalesChannelPremiumComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
ReportByProductSalesChannelPremiumModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
module.exports = ".form-control-sm {\n  background-color: #ffffff;\n  background-clip: padding-box;\n  border: 1px solid #e4e6ef;\n  padding: 0px 0.75rem;\n}\n\n.mat-datepicker-toggle {\n  position: absolute;\n  top: 0px;\n  right: 8px;\n}\n\ntable {\n  overflow: hidden;\n  width: 100%;\n  border-collapse: unset;\n}\n\ntable tr {\n  width: 100%;\n  overflow: hidden;\n}\n\ntable tr th,\ntable tr td {\n  text-align: center;\n  position: relative;\n  border-collapse: unset;\n}\n\ntable tr th span,\ntable tr td span {\n  width: 50%;\n  display: block;\n  float: left;\n  text-align: center;\n}\n\n.search-display {\n  width: 40%;\n  float: left;\n}\n\n.search-display div {\n  width: 100%;\n  overflow: hidden;\n}\n\n.search-display div span {\n  width: 33%;\n  display: inline-block;\n  float: left;\n}\n\n.right-border-transform {\n  width: 1px;\n  height: 100%;\n  background-color: #000;\n  transform: rotate(0deg);\n  position: absolute;\n  top: 0;\n  left: 49%;\n}\n\n.from-date button {\n  padding: 0;\n  position: absolute;\n  right: 0;\n  width: auto;\n  color: #FFFFFF;\n  background-color: #005f99;\n  border-color: #005f99;\n  height: 35px;\n  padding: 0 10px;\n}\n\n@media screen and (min-width: 320px) and (max-width: 571px) {\n  .from-date {\n    position: relative;\n  }\n  .from-date .input-date {\n    width: 85%;\n  }\n  .from-date button {\n    top: 23px;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */";
