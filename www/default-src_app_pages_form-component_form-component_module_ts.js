...
var isArray = __webpack_require__(/*! isarray */ 93347)
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs */ 58824);
...
/* harmony import */ var _modules_loading_toast_alert_model_alert_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/loading-toast/alert-model/alert.service */ 60940);
/* harmony import */ var _pages_currency_exchange_currency_exchange_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../pages/currency-exchange/currency-exchange.service */ 19113);
/* harmony import */ var _const_data_value__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./const-data-value */ 99785);
/* harmony import */ var _rate_datas_motor_rate_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./rate-datas/motor-rate.service */ 76545);
...
let GlobalFunctionService = class GlobalFunctionService {
    constructor(numberPipe, alert, exChangeService, motorService) {
        ...
        this.testingFunResult = new rxjs__WEBPACK_IMPORTED_MODULE_5__.BehaviorSubject(null);
        this.paPremiumResult = new rxjs__WEBPACK_IMPORTED_MODULE_6__.Subject();
        this.smSumInsuredAmtResult = new rxjs__WEBPACK_IMPORTED_MODULE_5__.BehaviorSubject(null);
        this.paCoverageResult = new rxjs__WEBPACK_IMPORTED_MODULE_5__.BehaviorSubject(null);
        this.normalCoverageResult = new rxjs__WEBPACK_IMPORTED_MODULE_5__.BehaviorSubject(null);
        this.motorTotalSiResult = new rxjs__WEBPACK_IMPORTED_MODULE_5__.BehaviorSubject(null);
        this.paPolicyValidationResult = new rxjs__WEBPACK_IMPORTED_MODULE_5__.BehaviorSubject(null);
        this.halfOfSumInsuredResult = new rxjs__WEBPACK_IMPORTED_MODULE_5__.BehaviorSubject(null);
        this.snakeSumInsuredResult = new rxjs__WEBPACK_IMPORTED_MODULE_5__.BehaviorSubject(null);
        this.travelPremiumResult = new rxjs__WEBPACK_IMPORTED_MODULE_5__.BehaviorSubject(null);
        this.totalTravelUnitResult = new rxjs__WEBPACK_IMPORTED_MODULE_5__.BehaviorSubject(null);
        this.travelPlanResult = new rxjs__WEBPACK_IMPORTED_MODULE_5__.BehaviorSubject(null);
        this.currenyValueObs = new rxjs__WEBPACK_IMPORTED_MODULE_5__.BehaviorSubject("MMK");
        this.tempFormData = {};
        this.exChange = 1650;
        this.optionResultChange = new rxjs__WEBPACK_IMPORTED_MODULE_6__.Subject();
    }
    getRate(type) {
    ...
    snakeSumInsured(currentValue, activeForm, option, form) {
        let valInt = 0;
    ...
    validEndoTerm(currentValue, activeForm, option, form) {
        ...
        if (parentKey) {
            if (policy == "T-003") {
                ...
                let age = Math.ceil(moment__WEBPACK_IMPORTED_MODULE_0__().diff(dob, 'years', true));
                if (age > 55) {
    ...
    validDOBEDU(currentValue, activeForm, option, form) {
    ...
    validDOBHealth(currentValue, activeForm, option, form) {
        let dob = activeForm['date_of_birth'];
        let age = Math.ceil(moment__WEBPACK_IMPORTED_MODULE_0__().diff(dob, 'years', true));
        // ENDO_POLICY_TERM
        if (age >= 6 && age <= 75) {
    ...
    validDOBEndo(currentValue, activeForm, option, form) {
        let dob = activeForm['date_of_birth'];
        let age = Math.ceil(moment__WEBPACK_IMPORTED_MODULE_0__().diff(dob, 'years', true));
        // ENDO_POLICY_TERM
        if (age >= 10 && age <= 60) {
    ...
    motorOwnDamage(motorDetail) {
        return this.getMotorRate(motorDetail).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.map)((res) => {
            if (res)
                return res.rate;
            return 0;
        }));
    ...
    motorThirdParty(motorDetail) {
        return this.getMotorThirdRate(motorDetail).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.map)((res) => {
            if (res)
                return res.rate;
            return 0;
        }));
    ...
    motorSRCC(motorDetail) {
        ...
        if (sumIn > 0) {
            ...
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.of)(sumIn * rate);
        }
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.of)(0);
        // }))
    }
    motorWindScreen(motorDetail) {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.of)(windscreen_value * rate);
    }
    motorMedicalExpense(motorDetail) {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.of)(fixed);
    }
    ...
    motorTheft(motorDetail) {
        ...
        return this.motorOwnDamage(motorDetail).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.map)(res => {
            if (res > 0) {
                let rate = 0;
                if (currency == 'MMK' && typeOfVehicle != "T-MCC") {
                    rate = 0.15;
    ...
    motorLiability() {
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.of)(25);
    }
    motorPaidDriver(motorDriverDetail) {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.of)(30 * length);
    }
    ...
    travelPlan(currentValue, activeForm, options) {
    ...
    validSharePercent(currentValue, activeForm, option, form) {
    ...
    travelPremium(currentValue, activeForm, option, form) {
        ...
        if (plan && duration && unit) {
            searchData = plan == 'T-INBOUND' ? _const_data_value__WEBPACK_IMPORTED_MODULE_3__.IN_BOUND : _const_data_value__WEBPACK_IMPORTED_MODULE_3__.OUT_BOUND;
    ...
    totalTravelUnit(currentValue, activeForm, options, form) {
        let noTraveler = 1;
        let insuredUnit = 0;
        if (activeForm['no_of_traveler']) {
...
GlobalFunctionService.ctorParameters = () => [
    ...
    { type: _modules_loading_toast_alert_model_alert_service__WEBPACK_IMPORTED_MODULE_1__.AlertService },
    { type: _pages_currency_exchange_currency_exchange_service__WEBPACK_IMPORTED_MODULE_2__.LatestCurrencyExchangeService },
    { type: _rate_datas_motor_rate_service__WEBPACK_IMPORTED_MODULE_4__.MotorRateService }
];
GlobalFunctionService = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
...
let CurrencyExchangeService = class CurrencyExchangeService extends _core_biz_operation_service__WEBPACK_IMPORTED_MODULE_1__.BizOperationService {
    ...
    getList(search = {}) {
        ...
        if (search.startDate) {
            url = url + "startDate=" + moment__WEBPACK_IMPORTED_MODULE_2__(search.startDate).format("YYYY-MM-DD") + "&";
        }
        if (search.endDate) {
            url = url + "endDate=" + moment__WEBPACK_IMPORTED_MODULE_2__(search.endDate).format("YYYY-MM-DD") + "&";
        }
        // if (search.currency) {
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_button_box_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./button-box.component.html */ 70972);
...
ButtonBoxComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_button_box_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_checkbox_box_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./checkbox-box.component.html */ 13128);
...
CheckboxBoxComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_checkbox_box_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_custom_dialog_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./custom-dialog.component.html */ 79156);
...
CustomDialogComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_custom_dialog_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_date_box_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./date-box.component.html */ 37360);
...
DateBoxComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_date_box_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        providers: [
...
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_dialog_box_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./dialog-box.component.html */ 48395);
...
DialogBoxComponent.propDecorators = {
    internalConfig: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_7__.Input }]
};
DialogBoxComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        selector: 'app-dialog-box',
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_dialog_box_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_edit_button_modal_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./edit-button-modal.component.html */ 63754);
...
EditButtonModalComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_edit_button_modal_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_edit_input_modal_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./edit-input-modal.component.html */ 74273);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs/operators */ 41082);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rxjs/operators */ 31607);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rxjs/operators */ 2014);
/* harmony import */ var src_app_modules_loading_toast_alert_model_alert_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/modules/loading-toast/alert-model/alert.service */ 60940);
...
/* harmony import */ var _field_interface__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../field.interface */ 21558);
...
EditInputModalComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_11__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_edit_input_modal_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_export_config_modal_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./export-config-modal.component.html */ 85198);
...
ExportConfigModalComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_export_config_modal_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_file_box_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./file-box.component.html */ 36101);
...
FileBoxComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_file_box_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony import */ var _angular_material_select__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! @angular/material/select */ 36109);
...
/* harmony import */ var _angular_material_radio__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! @angular/material/radio */ 63387);
/* harmony import */ var _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! @angular/material/checkbox */ 46598);
...
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ 44070);
...
/* harmony import */ var _angular_material_form_field__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! @angular/material/form-field */ 76393);
...
/* harmony import */ var _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! @angular/material/datepicker */ 21349);
/* harmony import */ var _angular_material_input__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! @angular/material/input */ 57574);
/* harmony import */ var _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! @ng-select/ng-select */ 15025);
/* harmony import */ var ngx_currency__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ngx-currency */ 40287);
/* harmony import */ var _angular_material_core__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! @angular/material/core */ 26816);
...
/* harmony import */ var angularx_qrcode__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! angularx-qrcode */ 68586);
...
/* harmony import */ var _modules_languages_languages_modules__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../../modules/languages/languages.modules */ 63699);
...
FormComponentModule = (0,tslib__WEBPACK_IMPORTED_MODULE_27__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_28__.NgModule)({
        ...
        imports: [
            ...
            _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_34__.NgbDatepickerModule,
            ...
            _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_34__.NgbTypeaheadModule,
            ...
            _modules_languages_languages_modules__WEBPACK_IMPORTED_MODULE_26__.LanguageModule
        ],
        providers: [_angular_common__WEBPACK_IMPORTED_MODULE_29__.DatePipe, _angular_common__WEBPACK_IMPORTED_MODULE_29__.DecimalPipe]
    })
], FormComponentModule);
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_form_view_modal_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./form-view-modal.component.html */ 42569);
...
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ 44070);
/* harmony import */ var _core_global_fun_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../core/global-fun.service */ 73762);
/* harmony import */ var _dynamic_form_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../dynamic-form.component */ 8246);
...
FormViewModalComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_form_view_modal_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_import_config_modal_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./import-config-modal.component.html */ 91272);
...
/* harmony import */ var src_app_modules_loading_toast_alert_model_alert_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/modules/loading-toast/alert-model/alert.service */ 60940);
/* harmony import */ var _dashboard_services_form_ui_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../dashboard/services/form-ui.service */ 41323);
...
ImportConfigModalComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_import_config_modal_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_input_box_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./input-box.component.html */ 66451);
...
InputBoxComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_input_box_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_label_box_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./label-box.component.html */ 88606);
...
LabelBoxComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_label_box_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_label_config_modal_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./label-config-modal.component.html */ 93745);
...
LabelConfigModalComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_label_config_modal_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_nrc_popup_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./nrc-popup.page.html */ 96901);
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs */ 32354);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs */ 2014);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rxjs */ 62489);
...
/* harmony import */ var _nrc_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./nrc-data */ 22869);
...
let NrcPopupPage = class NrcPopupPage {
    constructor(modal, cdf, masterDataService) {
        this.modal = modal;
        this.cdf = cdf;
        this.masterDataService = masterDataService;
        this.nrcStage = _nrc_data__WEBPACK_IMPORTED_MODULE_3__.nrcData;
        this.submited = false;
        this.townShip = [];
        this.stageOption = [];
        this.townshipOption = [];
    ...
    setForm() {
        this.nrcForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormGroup({
            "stage": new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormControl(null, [_angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required]),
            "township": new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormControl(null, [_angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required]),
            "prefix": new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormControl('N', [_angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required]),
            "nrc": new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormControl(null, [_angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.maxLength(6), _angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.minLength(6), _angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.pattern("[0-9]*")]),
        });
    }
    getMaster() {
    ...
    getStage() {
        return this.masterDataService.getDataByType("NRC_REGION").pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_6__.map)(x => this.getFormatOpt(x)), (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.catchError)(e => {
    ...
    getType() {
        return this.masterDataService.getDataByType("NRC_TYPE").pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_6__.map)(x => this.getFormatOpt(x)), (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.catchError)(e => {
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.of)([]);
        }));
    }
    getFormatOpt(res) {
...
NrcPopupPage = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
        selector: 'app-nrc-popup',
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_nrc_popup_page_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_page_config_modal_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./page-config-modal.component.html */ 96792);
...
PageConfigModalComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_page_config_modal_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_print_view_box_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./print-view-box.component.html */ 92323);
...
PrintViewBoxComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_print_view_box_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_radio_box_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./radio-box.component.html */ 56295);
...
RadioBoxComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_radio_box_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_select_box_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./select-box.component.html */ 6012);
...
SelectBoxComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_select_box_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
const API_MOTOR_URL = `${_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/fire-policy/dynamic/info`;
...
PolicyHolderService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Injectable)({
        providedIn: 'root'
    })
], PolicyHolderService);
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_addon_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./addon-print.component.html */ 85672);
...
AddonPrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_addon_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_coverage_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./coverage-print.component.html */ 75102);
...
CoveragePrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_coverage_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_education_life_griph_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./education-life-griph-print.component.html */ 12409);
/* harmony import */ var _education_life_griph_print_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./education-life-griph-print.component.scss */ 64949);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/core */ 14001);
/* harmony import */ var _modules_loading_toast_alert_model_alert_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../modules/loading-toast/alert-model/alert.service */ 60940);
/* harmony import */ var _core_global_fun_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../core/global-fun.service */ 73762);
...
EducationLifeGripPrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_education_life_griph_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        styles: [_education_life_griph_print_component_scss__WEBPACK_IMPORTED_MODULE_1__]
    })
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_education_life_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./education-life-print.component.html */ 61305);
/* harmony import */ var _education_life_print_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./education-life-print.component.scss */ 27570);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/core */ 14001);
/* harmony import */ var _core_global_fun_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../core/global-fun.service */ 73762);
...
EducationLifePrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_education_life_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        styles: [_education_life_print_component_scss__WEBPACK_IMPORTED_MODULE_1__]
    })
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_endo_griph_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./endo-griph-print.component.html */ 72227);
/* harmony import */ var _endo_griph_print_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./endo-griph-print.component.scss */ 95876);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/core */ 14001);
/* harmony import */ var _modules_loading_toast_alert_model_alert_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../modules/loading-toast/alert-model/alert.service */ 60940);
/* harmony import */ var _core_global_fun_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../core/global-fun.service */ 73762);
...
EndoGripPrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_endo_griph_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        styles: [_endo_griph_print_component_scss__WEBPACK_IMPORTED_MODULE_1__]
    })
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_endo_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./endo-print.component.html */ 59250);
/* harmony import */ var _endo_print_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./endo-print.component.scss */ 18827);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 14001);
...
EndoPrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_endo_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        styles: [_endo_print_component_scss__WEBPACK_IMPORTED_MODULE_1__]
    })
], EndoPrintComponent);
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_endo_sign_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./endo-sign-print.component.html */ 38745);
/* harmony import */ var _endo_sign_print_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./endo-sign-print.component.scss */ 98930);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ 14001);
...
EndoSignPrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_endo_sign_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        styles: [_endo_sign_print_component_scss__WEBPACK_IMPORTED_MODULE_1__]
    })
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_farmer_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./farmer-print.component.html */ 72368);
...
FarmerPrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_farmer_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_fire_detail_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./fire-detail-print.component.html */ 41274);
...
FireDetailPrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_fire_detail_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_fire_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./fire-print.component.html */ 65082);
/* harmony import */ var _fire_print_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fire-print.component.scss */ 13861);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/core */ 14001);
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../environments/environment */ 18260);
...
/* harmony import */ var _products_services_products_data_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../products/services/products-data.service */ 35618);
/* harmony import */ var _static_pages_fire_risk_models_services_fire_risk_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../static-pages/fire-risk/models&services/fire-risk.service */ 66977);
/* harmony import */ var _static_pages_fire_simple_page_models_services_fire_policy__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../static-pages/fire-simple-page/models&services/fire-policy */ 33319);
/* harmony import */ var _static_pages_fire_simple_page_models_services_fire_product_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../static-pages/fire-simple-page/models&services/fire-product.service */ 75103);
/* harmony import */ var _static_pages_fire_simple_page_models_services_fire_risk_address__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../static-pages/fire-simple-page/models&services/fire-risk-address */ 49353);
...
let FirePrintComponent = class FirePrintComponent {
    constructor(fireService, fireRsikService, policyHolderService, fireRiskAddressService, addonQuo, productSerice) {
        this.fireService = fireService;
...
FirePrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_fire_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        styles: [_fire_print_component_scss__WEBPACK_IMPORTED_MODULE_1__]
    })
], FirePrintComponent);
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_fire_risk_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./fire-risk-print.component.html */ 38938);
...
FireRiskPrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_fire_risk_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_health_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./health-print.component.html */ 75637);
...
HealthPrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_health_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_health_quo_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./health-quo-print.component.html */ 31941);
/* harmony import */ var _health_quo_print_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./health-quo-print.component.scss */ 7768);
...
HealthQuoPrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_9__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_health_quo_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        styles: [_health_quo_print_component_scss__WEBPACK_IMPORTED_MODULE_1__]
    })
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_moter_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./moter-print.component.html */ 8019);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/core */ 14001);
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../environments/environment */ 18260);
/* harmony import */ var _products_services_motor_print_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../products/services/motor-print.service */ 53709);
/* harmony import */ var _static_pages_fire_simple_page_models_services_fire_policy__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../static-pages/fire-simple-page/models&services/fire-policy */ 33319);
/* harmony import */ var _static_pages_fire_simple_page_models_services_fire_risk_address__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../static-pages/fire-simple-page/models&services/fire-risk-address */ 49353);
...
let MoterPrintComponent = class MoterPrintComponent {
    constructor(motorService, policyHolderService, fireRiskAddressService) {
        this.motorService = motorService;
        this.policyHolderService = policyHolderService;
        this.fireRiskAddressService = fireRiskAddressService;
        this.listData = [];
...
MoterPrintComponent.ctorParameters = () => [
    { type: _products_services_motor_print_service__WEBPACK_IMPORTED_MODULE_3__.MotorPrintService },
    { type: _static_pages_fire_simple_page_models_services_fire_policy__WEBPACK_IMPORTED_MODULE_4__.PolicyHolderService },
    { type: _static_pages_fire_simple_page_models_services_fire_risk_address__WEBPACK_IMPORTED_MODULE_5__.FireRiskAddressService }
];
MoterPrintComponent.propDecorators = {
    resourcesId: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__.Input }],
    signId: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__.Input }]
};
MoterPrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        selector: 'app-moter-print',
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_moter_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_pa_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./pa-print.component.html */ 67037);
...
PaPrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_pa_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_simple_page_print_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./simple-page-print.component.html */ 12006);
/* harmony import */ var _simple_page_print_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./simple-page-print.component.scss */ 10632);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/core */ 14001);
/* harmony import */ var _core_global_fun_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../core/global-fun.service */ 73762);
/* harmony import */ var _products_services_products_data_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../products/services/products-data.service */ 35618);
...
SimplePagePrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_simple_page_print_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        styles: [_simple_page_print_component_scss__WEBPACK_IMPORTED_MODULE_1__]
    })
...
/* harmony import */ var _education_life_print_education_life_print_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./education-life-print/education-life-print.component */ 52427);
/* harmony import */ var _endo_print_endo_print_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./endo-print/endo-print.component */ 4581);
/* harmony import */ var _endo_sign_print_endo_sign_print_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./endo-sign-print/endo-sign-print.component */ 71051);
/* harmony import */ var _farmer_print_farmer_print_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./farmer-print/farmer-print.component */ 62937);
/* harmony import */ var _fire_detail_print_fire_detail_print_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./fire-detail-print/fire-detail-print.component */ 95321);
/* harmony import */ var _fire_risk_print_fire_risk_print_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./fire-risk-print/fire-risk-print.component */ 85910);
/* harmony import */ var _health_print_health_print_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./health-print/health-print.component */ 41388);
/* harmony import */ var _health_quo_print_health_quo_print_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./health-quo-print/health-quo-print.component */ 35859);
/* harmony import */ var _moter_print_moter_print_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./moter-print/moter-print.component */ 32622);
/* harmony import */ var _pa_print_pa_print_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./pa-print/pa-print.component */ 43698);
/* harmony import */ var _simple_page_print_simple_page_print_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./simple-page-print/simple-page-print.component */ 82918);
...
const STATIC_PRINT_COMPONENT = {
    'print_1638594148571': _moter_print_moter_print_component__WEBPACK_IMPORTED_MODULE_10__.MoterPrintComponent,
    ...
    'print_1645157579888': _pa_print_pa_print_component__WEBPACK_IMPORTED_MODULE_11__.PaPrintComponent,
...
/* harmony import */ var _endo_print_endo_print_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./endo-print/endo-print.component */ 4581);
/* harmony import */ var _endo_griph_print_endo_griph_print_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./endo-griph-print/endo-griph-print.component */ 98987);
/* harmony import */ var _endo_sign_print_endo_sign_print_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./endo-sign-print/endo-sign-print.component */ 71051);
/* harmony import */ var ng_apexcharts__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ng-apexcharts */ 10407);
/* harmony import */ var _education_life_griph_print_education_life_griph_print_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./education-life-griph-print/education-life-griph-print.component */ 24204);
/* harmony import */ var _education_life_print_education_life_print_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./education-life-print/education-life-print.component */ 52427);
/* harmony import */ var _simple_page_print_simple_page_print_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./simple-page-print/simple-page-print.component */ 82918);
/* harmony import */ var _health_quo_print_health_quo_print_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./health-quo-print/health-quo-print.component */ 35859);
/* harmony import */ var _fire_print_fire_print_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./fire-print/fire-print.component */ 13548);
/* harmony import */ var _products_services_motor_print_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../products/services/motor-print.service */ 53709);
...
/***/ 12409:
/*!************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./src/app/pages/static-print/education-life-griph-print/education-life-griph-print.component.html ***!
  \************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 61305:
/*!************************************************************************************************************************************************************!*\
  !*** ./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./src/app/pages/static-print/education-life-print/education-life-print.component.html ***!
  \************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 72227:
/*!****************************************************************************************************************************************************!*\
  !*** ./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./src/app/pages/static-print/endo-griph-print/endo-griph-print.component.html ***!
  \****************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 59250:
/*!****************************************************************************************************************************************!*\
  !*** ./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./src/app/pages/static-print/endo-print/endo-print.component.html ***!
  \****************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 38745:
/*!**************************************************************************************************************************************************!*\
  !*** ./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./src/app/pages/static-print/endo-sign-print/endo-sign-print.component.html ***!
  \**************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 65082:
/*!****************************************************************************************************************************************!*\
  !*** ./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./src/app/pages/static-print/fire-print/fire-print.component.html ***!
  \****************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("\n\n<div class=\"addon-print\" *ngIf=\"policyHolder\">\n  <div class=\"title-style mt-5 mb-3\">Policyholder</div>\n  <div class=\"row\" >\n    <div class=\"col-sm-3 text-bold\">\n      Name\n    </div>\n    <div class=\"col-sm-6\">\n      {{policyHolder.title}} {{policyHolder.firstName}}{{policyHolder.middleName}}{{policyHolder.lastName}}\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-sm-3 text-bold\">\n      ID\n    </div>\n    <div class=\"col-sm-6\">\n    {{policyHolder.cprNumber}} \n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-sm-3 text-bold\">\n      Date of Birth\n    </div>\n    <div class=\"col-sm-6\">\n      {{policyHolder.dateOfBirth}}\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-sm-3 text-bold\">\n      Mobile\n    </div>\n    <div class=\"col-sm-6\">\n      {{policyHolder.partyAddress[0].mobileNo}}\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-sm-3 text-bold\">\n      Email\n    </div>\n    <div class=\"col-sm-6\">\n      {{policyHolder.partyAddress[0].eMailId}}\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-sm-3 text-bold\">\n      Address\n    </div>\n    <div class=\"col-sm-6\">\n      {{policyHolder.partyAddress[0].address1}}/{{policyHolder.partyAddress[0].address2}}/{{policyHolder.partyAddress[0].address3}}/{{policyHolder.partyAddress[0].city}}/{{policyHolder.partyAddress[0].district}}/{{policyHolder.partyAddress[0].state}}\n    </div>\n  </div>\n  \n</div>\n\n<div class=\"addon-print\">\n  <div class=\"title-style mt-5 mb-3\">Policy Information Detail</div>\n  <table width=\"100%\">\n    <tr>\n      <td class=\"field-col\" style=\"background-color: rgb(221, 235, 247);color: rgb(31, 78, 120);\">Policy Effective Date\n      </td>\n      <td class=\"value-col\">{{detail.startDate | date: 'dd/MM/YYYY'}}</td>\n      <td class=\"field-col\" style=\"background-color: rgb(221, 235, 247);color: rgb(31, 78, 120);\">Policy Expiry Date\n      </td>\n      <td class=\"value-col\">{{detail.endDate | date: 'dd/MM/YYYY'}}</td>\n      <td class=\"field-col\" style=\"background-color: rgb(221, 235, 247);color: rgb(31, 78, 120);\">Policy Duration Days\n      </td>\n      <td class=\"value-col\">{{detail.policyDuration}} Days</td>\n    </tr>\n    <tr>\n      <td class=\"field-col\" style=\"background-color: rgb(221, 235, 247);color: rgb(31, 78, 120);\">Policy Type</td>\n      <td class=\"value-col\" colspan=\"2\">{{detail.policyType == \"T-001\" ? \"Normal\" : \"Declaration\"}}</td>\n      <td class=\"field-col\" style=\"background-color: rgb(221, 235, 247);color: rgb(31, 78, 120);\">Currency</td>\n      <td class=\"value-col\" colspan=\"2\">{{detail.currency}}</td>\n     \n    </tr>\n    <tr>\n      <td class=\"field-col\" style=\"background-color: rgb(221, 235, 247);color: rgb(31, 78, 120);\">Risk Address</td>\n      <td class=\"value-col\" colspan=\"10\">{{address.f_house_no}}/{{address.f_block_no}}/{{address.f_area_name}}/{{address.stateValue}}/{{address.districtValue}}/{{address.townshipValue}}</td>\n    </tr>\n  </table>\n</div>\n\n\n<div class=\"addon-print\">\n  <div class=\"title-style mt-5 mb-3\">Risk Detail Information</div>\n  <table class=\"tbody-align\">\n    <tr>\n      <td class=\"field-col\">\n        Building Description \n      </td>\n      <td class=\"field-col\">\n        Type of Building\n      </td>\n      <td class=\"field-col\">\n        Occupation of Building\n      </td>\n      <td class=\"field-col\">\n        Building Class\n      </td>\n      <td class=\"field-col\">\n       Total Square Feet\n      </td>\n      <td class=\"field-col\">\n        Year of Construction \n      </td>\n      <td class=\"field-col\">\n        Proposed Building SI\n      </td>\n      <td class=\"field-col\">\n        Proposed Furniture\n      </td>\n      <td class=\"field-col\">\n        Proposed Machinery SI\n      </td>\n      <td class=\"field-col\">\n        Proposed Stock SI\n      </td>\n      <td class=\"field-col\">\n        Total SI\n      </td>\n    </tr>\n    <tbody class=\"tbody-align val-col\">\n      <ng-container *ngFor=\"let data of listData;\">\n        <tr>\n          <td class=\"field-value\">{{data.buildingDescription}}</td>\n          <td class=\"field-value\">{{data.typeOfBuildingValue}}</td>\n          <td class=\"field-value\">{{data.occupationOfBuildingValue}}</td>\n          <td class=\"field-value\">{{data.buildingClassValue}}</td>\n          <td class=\"field-value\">{{data.totalSquareFoot}}</td>\n          <td class=\"field-value\">{{data.yearOfConstruction}}</td>\n          <td class=\"field-value\">{{data.buildingSi}}</td>\n          <td class=\"field-value\">{{data.proposedFurniture}}</td>\n          <td class=\"field-value\">{{data.proposedMachinerySI}}</td>\n          <td class=\"field-value\">{{data.proposeStockValue}}</td>\n          <td class=\"field-value\">{{data.riskSi | number}}</td>\n        </tr>\n      </ng-container>\n    </tbody>\n  </table>\n</div>\n\n\n<div class=\"addon-print\">\n  <div class=\"title-style  mt-5 mb-3\">Additional Cover Information</div>\n  <table class=\"tbody-align\">\n    <tr>\n      <td class=\"field-col\">\n        Building Description\n      </td>\n      <td class=\"field-col\">\n        Fire Premium\n      </td>\n      <td class=\"field-col\">\n        STHTC\n      </td>\n      <td class=\"field-col\">\n        Impact Damage\n      </td>\n      <td class=\"field-col\">\n        RSMD\n      </td>\n      <td class=\"field-col\">\n        Burglary\n      </td>\n      <td class=\"field-col\">\n        Air Craft Damage\n      </td>\n      <td class=\"field-col\">\n        EQ\n      </td>\n      <td class=\"field-col\">\n        Spontaneous Combus\n      </td>\n      <td class=\"field-col\">\n        Subsidence and Landslid\n      </td>\n      <td class=\"field-col\">\n        War Risk\n      </td>\n      <td class=\"field-col\">\n        Explosion \n      </td>\n      <td class=\"field-col\">\n        Flood and Inundati \n      </td>\n      <td class=\"field-col\">\n        Total Premium \n      </td>\n    </tr>\n    <tbody class=\"tbody-align val-col\">\n      <ng-container *ngFor=\"let data of addOnData;\">\n        <tr>\n          <td class=\"field-value\">{{data.description}}</td>\n          <td class=\"field-value\">{{data.firepremium || 0}}</td>\n          <td class=\"field-value\">{{data.STHTC}}</td>\n          <td class=\"field-value\">{{data.IMPD}}</td>\n          <td class=\"field-value\">{{data.RSMD}}</td>\n          <td class=\"field-value\">{{data.BURGLARY}}</td>\n          <td class=\"field-value\">{{data.ACD}}</td>\n          <td class=\"field-value\">{{data.EQ}}</td>\n          <td class=\"field-value\">{{data.SPONTCOMB}}</td>\n          <td class=\"field-value\">{{data.SUBLSLD}}</td>\n          <td class=\"field-value\">{{data.WARRISK}}</td>\n          <td class=\"field-value\">{{data.EXPLOSION}}</td>\n          <td class=\"field-value\">{{data.FLOOD}}</td>\n          <td class=\"field-value\">{{data.premium}}</td>\n        </tr>\n      </ng-container>\n    </tbody>\n  </table>\n</div>\n\n<div class=\"addon-print\">\n  <div class=\"title-style mt-5 mb-3\">Insurance Detail</div>\n  <table width=\"100%\">\n    <tr>\n      <td class=\"field-col\" style=\"background-color: rgb(221, 235, 247);color: rgb(31, 78, 120);\">Total SI</td>\n      <td class=\"value-col\" colspan=\"4\">{{totalSi}}</td>\n      <td class=\"field-col\" style=\"background-color: rgb(221, 235, 247);color: rgb(31, 78, 120);\">Total Premium</td>\n      <td class=\"value-col\" colspan=\"4\">{{totalPremium }}</td>\n    </tr>\n  </table>\n</div>\n\n<div class=\"addon-print\">\n  <div class=\"row\">\n    <div class=\"title-style text-bold mt-5 mb-3\">Declaration By Proposer</div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col\">\n       <p>I hereby declare that the statements made by me in this Proposal are true to the best of my knowledge and belief and I hereby agree that this declaration  shall from  the basic of the contract between me and KBZ MS Insurance Co.,Ltd. in the event of the Proposal being accepted</p>\n    </div>\n  </div>\n</div>\n\n<div class=\"moter-print\">\n\n  <div class=\"sign-row\">\n    <div class=\"sign-box\">\n      <label>DATE</label>\n      <div class=\"sign-area\"></div>\n    </div>\n    <div class=\"sign-box\">\n      <label>PROPOSER SIGNATURE</label>\n      <div class=\"sign-area\">\n        <ng-container *ngIf=\"signId\">\n          <img [src]=\"DEFAULT_DOWNLOAD_URL+signId\" alt=\"\" class=\"sign-img\">\n        </ng-container>\n      </div>\n    </div>\n  </div>\n\n\n</div>");
...
/***/ 31941:
/*!****************************************************************************************************************************************************!*\
  !*** ./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./src/app/pages/static-print/health-quo-print/health-quo-print.component.html ***!
  \****************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("\n\n<div class=\"addon-print\" *ngIf=\"policyHolder\">\n  <div class=\"title-style mt-5 mb-3\">Policyholder</div>\n  <div class=\"row\" >\n    <div class=\"col-sm-3 text-bold\">\n      Name\n    </div>\n    <div class=\"col-sm-6\">\n      {{policyHolder.title}} {{policyHolder.firstName}}{{policyHolder.middleName}}{{policyHolder.lastName}}\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-sm-3 text-bold\">\n      ID\n    </div>\n    <div class=\"col-sm-6\">\n    {{policyHolder.cprNumber}} \n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-sm-3 text-bold\">\n      Date of Birth\n    </div>\n    <div class=\"col-sm-6\">\n      {{policyHolder.dateOfBirth}}\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-sm-3 text-bold\">\n      Mobile\n    </div>\n    <div class=\"col-sm-6\">\n      {{policyHolder.partyAddress[0].mobileNo}}\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-sm-3 text-bold\">\n      Email\n    </div>\n    <div class=\"col-sm-6\">\n      {{policyHolder.partyAddress[0].eMailId}}\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-sm-3 text-bold\">\n      Address\n    </div>\n    <div class=\"col-sm-6\">\n      {{policyHolder.partyAddress[0].address1}}/{{policyHolder.partyAddress[0].address2}}/{{policyHolder.partyAddress[0].address3}}/{{policyHolder.partyAddress[0].city}}/{{policyHolder.partyAddress[0].district}}/{{policyHolder.partyAddress[0].state}}\n    </div>\n  </div>\n  \n</div>\n\n<div class=\"addon-print\">\n  <div class=\"title-style mt-5 mb-3\">Policy Information Detail</div>\n  <table width=\"100%\">\n    <tr>\n      <td class=\"field-col\" style=\"background-color: rgb(221, 235, 247);color: rgb(31, 78, 120);\">Policy Effective Date\n      </td>\n      <td class=\"value-col\">{{motorDetail.mPeriodOfInsuranceFrom | date: 'dd/MM/YYYY'}}</td>\n      <td class=\"field-col\" style=\"background-color: rgb(221, 235, 247);color: rgb(31, 78, 120);\">Policy Expiry Date\n      </td>\n      <td class=\"value-col\">{{motorDetail.mPeriodOfInsuranceTo | date: 'dd/MM/YYYY'}}</td>\n      <td class=\"field-col\" style=\"background-color: rgb(221, 235, 247);color: rgb(31, 78, 120);\">Policy Duration Days\n      </td>\n      <td class=\"value-col\">{{motorDetail.policyDuration}} Days</td>\n    </tr>\n    <tr>\n      <td class=\"field-col\" style=\"background-color: rgb(221, 235, 247);color: rgb(31, 78, 120);\">Currency</td>\n      <td class=\"value-col\" colspan=\"10\">{{motorDetail.currency}}</td>\n     \n    </tr>\n  </table>\n</div>\n\n\n<div class=\"addon-print\">\n  <div class=\"title-style mt-5 mb-3\">Risk Detail Information</div>\n  <table class=\"tbody-align\">\n    <tr>\n      <td class=\"field-col\">\n        Vehicle No. \n      </td>\n      <td class=\"field-col\">\n        Make/ Model\n      </td>\n      <td class=\"field-col\">\n        CC/ Tonnage\n      </td>\n      <td class=\"field-col\">\n        Year of Manufacture\n      </td>\n      <td class=\"field-col\">\n       Type of Vehicle\n      </td>\n      <td class=\"field-col\">\n        Type of Coverage \n      </td>\n      <td class=\"field-col\">\n        Excess\n      </td>\n      <td class=\"field-col\">\n        Windscreen SI\n      </td>\n      <td class=\"field-col\">\n        Total SI\n      </td>\n    </tr>\n    <tbody class=\"tbody-align val-col\">\n      <ng-container *ngFor=\"let data of listData;\">\n        <tr>\n          <td class=\"field-value\">{{data.vehicleNo}}</td>\n          <td class=\"field-value\">{{data.model}}</td>\n          <td class=\"field-value\">{{data.tonnage}}</td>\n          <td class=\"field-value\">{{data.yearOfManufacture}}</td>\n          <td class=\"field-value\">{{data.typeOfVehicle}}</td>\n          <td class=\"field-value\">{{data.typeOfCoverage}}</td>\n          <td class=\"field-value\">{{data.excess}}</td>\n          <td class=\"field-value\">{{data.windscreenSI}}</td>\n          <td class=\"field-value\">{{data.totalSI | number}}</td>\n        </tr>\n      </ng-container>\n    </tbody>\n  </table>\n</div>\n\n\n\n\n\n<div class=\"addon-print\">\n  <div class=\"title-style mt-5 mb-3\">Basic Cover Information</div>\n  <table class=\"tbody-align\">\n    <tr>\n      <td class=\"field-col\">\n        OD\n      </td>\n      <td class=\"field-col\">\n        Thrid Party\n      </td>\n      <td class=\"field-col\">\n        SRCC\n      </td>\n      <td class=\"field-col\">\n        Wind Screen\n      </td>\n      <td class=\"field-col\">\n        Total Premium of Basic Cover \n      </td>\n    </tr>\n    <tbody class=\"tbody-align val-col\">\n      <ng-container *ngFor=\"let data of listData;\">\n        <tr>\n          <td class=\"field-value\">{{data.OD}}</td>\n          <td class=\"field-value\">{{data.thirdParty}}</td>\n          <td class=\"field-value\">{{data.srcc}}</td>\n          <td class=\"field-value\">{{data.windScreen}}</td>\n          <td class=\"field-value\">{{data.totalPremiumofBasicCover}}</td>\n        </tr>\n      </ng-container>\n    </tbody>\n  </table>\n</div>\n\n\n\n\n\n\n<div class=\"addon-print\">\n  <div class=\"title-style  mt-5 mb-3\">Additional Cover Information</div>\n  <table class=\"tbody-align\">\n    <tr>\n      <td class=\"field-col\">\n        War Risk\n      </td>\n      <td class=\"field-col\">\n        Act of God\n      </td>\n      <td class=\"field-col\">\n        Theft\n      </td>\n      <td class=\"field-col\">\n        No Betterment Endorsement\n      </td>\n      <td class=\"field-col\">\n        Cross Border\n      </td>\n      <td class=\"field-col\">\n        Loss of Luggage\n      </td>\n      <td class=\"field-col\">\n        Medical Expense\n      </td>\n      <td class=\"field-col\">\n        Passenger Liability  \n      </td>\n      <td class=\"field-col\">\n        Paid Driver \n      </td>\n      <td class=\"field-col\">\n        Excess \n      </td>\n      <td class=\"field-col\">\n        Total Premium of Additional Cover  \n      </td>\n    </tr>\n    <tbody class=\"tbody-align val-col\">\n      <ng-container *ngFor=\"let data of listData;\">\n        <tr>\n          <td class=\"field-value\">{{data.warRisk}}</td>\n          <td class=\"field-value\">{{data.actOfGod}}</td>\n          <td class=\"field-value\">{{data.theft}}</td>\n          <td class=\"field-value\">{{data.noBettermentEndorsement}}</td>\n          <td class=\"field-value\">{{data.crossBorder}}</td>\n          <td class=\"field-value\">{{data.lossOfLuggage}}</td>\n          <td class=\"field-value\">{{data.medicalExpense}}</td>\n          <td class=\"field-value\">{{data.passengerLiability}}</td>\n          <td class=\"field-value\">{{data.paidDriver}}</td>\n          <td class=\"field-value\">{{data.excess}}</td>\n          <td class=\"field-value\">{{data.totalPremium}}</td>\n        </tr>\n      </ng-container>\n    </tbody>\n  </table>\n</div>\n\n<div class=\"addon-print\">\n  <div class=\"title-style mt-5 mb-3\">Insurance Detail</div>\n  <table width=\"100%\">\n    <tr>\n      <td class=\"field-col\" style=\"background-color: rgb(221, 235, 247);color: rgb(31, 78, 120);\">Total SI</td>\n      <td class=\"value-col\" colspan=\"4\">{{motorDetail.mTotalRiskSi}}</td>\n      <td class=\"field-col\" style=\"background-color: rgb(221, 235, 247);color: rgb(31, 78, 120);\">Total Premium</td>\n      <td class=\"value-col\" colspan=\"4\">{{motorDetail.mVehicleSi}}</td>\n    </tr>\n  </table>\n</div>\n\n\n<div class=\"addon-print\">\n  <div class=\"row\">\n    <div class=\"title-style text-bold mt-5 mb-3\">Declaration By Proposer</div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col\">\n       <p>I hereby declare that the statements made by me in this Proposal are true to the best of my knowledge and belief and I hereby agree that this declaration  shall from  the basic of the contract between me and KBZ MS Insurance Co.,Ltd. in the event of the Proposal being accepted</p>\n    </div>\n  </div>\n</div>\n\n\n\n<div class=\"moter-print\">\n\n  <div class=\"sign-row\">\n    <div class=\"sign-box\">\n      <label>DATE</label>\n      <div class=\"sign-area\"></div>\n    </div>\n    <div class=\"sign-box\">\n      <label>PROPOSER SIGNATURE</label>\n      <div class=\"sign-area\">\n        <ng-container *ngIf=\"signId\">\n          <img [src]=\"DEFAULT_DOWNLOAD_URL+signId\" alt=\"\" class=\"sign-img\">\n        </ng-container>\n      </div>\n    </div>\n  </div>\n</div>");
...
/***/ 12006:
/*!******************************************************************************************************************************************************!*\
  !*** ./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./src/app/pages/static-print/simple-page-print/simple-page-print.component.html ***!
  \******************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
module.exports = ".currency-tag {\n  position: absolute;\n  right: 5px;\n  font-size: 0.9rem;\n  text-transform: uppercase;\n  top: 50%;\n  transform: translateY(-50%);\n}\n\n[class*=col-] .currency-tag {\n  right: 20px;\n}\n\n.currency-input-tag {\n  padding-right: 35px;\n}\n\n.currency-group {\n  position: relative;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
"use strict";
module.exports = ".print-grid {\n  font-size: 0.75rem;\n}\n.row {\n  margin: 5px 5px;\n}\n.field-col {\n  text-align: center;\n  padding: 5px 5px;\n  width: 100px;\n  font-size: 0.75rem;\n}\n.value-col {\n  padding: 5px 5px;\n  text-align: center;\n  width: 120px;\n  font-size: 0.75rem;\n}\n.title-style {\n  font-size: 0.9rem;\n}\ntable td {\n  border: 1px solid #9BC2E6;\n  border-collapse: collapse;\n}\n.print-header {\n  background-color: white;\n  margin: 0px;\n  margin-bottom: 1.25rem;\n  position: relative;\n}\n.header-title {\n  display: flex;\n  align-items: center;\n  font-size: 1rem;\n  font-weight: bold;\n  color: #005f99;\n  position: absolute;\n}\n.header-title .logo {\n  width: 30%;\n  margin-right: 10px;\n}\n.header-logo {\n  display: flex;\n  justify-content: center;\n}\n.header-logo .logo {\n  width: 30%;\n  margin-right: 10px;\n}\n.product-name {\n  font-size: 1.5rem;\n  font-weight: bold;\n  width: 100%;\n  text-align: center;\n}\n.print-footer {\n  display: flex;\n  padding: 5px;\n  border-top: 1px solid #9BC2E6;\n}\n.print-footer .logo {\n  width: 40px;\n  margin-right: 10px;\n}\n.qr {\n  position: absolute;\n  right: 10px;\n  top: 15px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
/***/ 64949:
/*!*********************************************************************************************************!*\
  !*** ./src/app/pages/static-print/education-life-griph-print/education-life-griph-print.component.scss ***!
  \*********************************************************************************************************/
/***/ ((module) => {
...
/***/ 27570:
/*!*********************************************************************************************!*\
  !*** ./src/app/pages/static-print/education-life-print/education-life-print.component.scss ***!
  \*********************************************************************************************/
/***/ ((module) => {
...
/***/ 95876:
/*!*************************************************************************************!*\
  !*** ./src/app/pages/static-print/endo-griph-print/endo-griph-print.component.scss ***!
  \*************************************************************************************/
/***/ ((module) => {
...
/***/ 18827:
/*!*************************************************************************!*\
  !*** ./src/app/pages/static-print/endo-print/endo-print.component.scss ***!
  \*************************************************************************/
/***/ ((module) => {
...
/***/ 98930:
/*!***********************************************************************************!*\
  !*** ./src/app/pages/static-print/endo-sign-print/endo-sign-print.component.scss ***!
  \***********************************************************************************/
/***/ ((module) => {
...
/***/ 13861:
/*!*************************************************************************!*\
  !*** ./src/app/pages/static-print/fire-print/fire-print.component.scss ***!
  \*************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = ".sign-row {\n  display: flex;\n  justify-content: space-between;\n  margin-top: 15px;\n  font-size: 0.9rem;\n}\n.sign-row .sign-area {\n  width: 150px;\n  min-height: 30px;\n  border-bottom: 1px #000 dashed;\n}\n.sign-row .sign-area .sign-img {\n  width: 150px;\n}\n.field-col, .field-value {\n  text-align: center;\n  padding: 5px 5px;\n  width: 150px;\n  background-color: #ddebf7;\n  font-size: 0.75rem;\n}\n.field-col {\n  text-align: center;\n  padding: 5px 5px;\n  width: 100px;\n  font-size: 0.75rem;\n}\n.value-col {\n  padding: 5px 5px;\n  text-align: center;\n  width: 120px;\n  font-size: 0.75rem;\n}\n.field-value {\n  background-color: #fff;\n}\ntable td {\n  border: 1px solid #9BC2E6;\n  border-collapse: collapse;\n}\n.title-style {\n  font-size: 0.9rem;\n  background-color: #f2f4f6db;\n  text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
/***/ 7768:
/*!*************************************************************************************!*\
  !*** ./src/app/pages/static-print/health-quo-print/health-quo-print.component.scss ***!
  \*************************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJoZWFsdGgtcXVvLXByaW50LmNvbXBvbmVudC5zY3NzIn0= */";
...
"use strict";
module.exports = ".sign-row {\n  display: flex;\n  justify-content: space-between;\n  margin-top: 15px;\n  font-size: 0.9rem;\n}\n.sign-row .sign-area {\n  width: 150px;\n  min-height: 30px;\n  border-bottom: 1px #000 dashed;\n}\n.sign-row .sign-area .sign-img {\n  width: 150px;\n}\n.field-col, .field-value {\n  text-align: center;\n  padding: 5px 5px;\n  width: 150px;\n  background-color: #ddebf7;\n  font-size: 0.75rem;\n}\n.field-col {\n  text-align: center;\n  padding: 5px 5px;\n  width: 100px;\n  font-size: 0.75rem;\n}\n.value-col {\n  padding: 5px 5px;\n  text-align: center;\n  width: 120px;\n  font-size: 0.75rem;\n}\n.field-value {\n  background-color: #fff;\n}\ntable td {\n  border: 1px solid #9BC2E6;\n  border-collapse: collapse;\n}\n.title-style {\n  font-size: 0.9rem;\n  background-color: #f2f4f6db;\n  text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
/***/ 10632:
/*!***************************************************************************************!*\
  !*** ./src/app/pages/static-print/simple-page-print/simple-page-print.component.scss ***!
  \***************************************************************************************/
/***/ ((module) => {
