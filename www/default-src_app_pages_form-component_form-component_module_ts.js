        ...
        if (this.config.type != 'policy') {
            ...
            if (prod) {
                if (prod.isAllowBackDate == 'no') {
                    ...
                    let toDate = moment__WEBPACK_IMPORTED_MODULE_4__().subtract(30, `days`);
                    this.fromMinDate = toDate.format('YYYY-MM-DD');
                    // this.fromMinDate = { year: parseInt(toDate.format('YYYY')), month: parseInt(toDate.format('M')), day: parseInt(toDate.format('D')) };
                    this.toMinDate = toDate.format('YYYY-MM-DD');
                    // this.toMinDate = { year: parseInt(toDate.format('YYYY')), month: parseInt(toDate.format('M')), day: parseInt(toDate.format('D')) };
...
DateBoxComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_9__.Component)({
        ...
        providers: [
            ...
            { provide: _angular_material_core__WEBPACK_IMPORTED_MODULE_11__.MAT_DATE_FORMATS, useValue: _core_is_json__WEBPACK_IMPORTED_MODULE_7__.MY_FORMATS },
        ],
        ...
        if (validation && config.show) {
            for (let val of validation) {
                if (val.type == _field_interface__WEBPACK_IMPORTED_MODULE_2__.ValidationType.REQUIRED) {
                    ...
                    let validat = config.type == 'number' ? _angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.max(val.value) : _angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.maxLength(val.value);
                    valid.push(validat);
                }
                else if (val.type == _field_interface__WEBPACK_IMPORTED_MODULE_2__.ValidationType.MIN && config.type != 'date') {
                    let validat = config.type == 'number' ? _angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.min(val.value) : _angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.minLength(val.value);
                    valid.push(validat);
                }
            }
        }
...
let FileBoxComponent = class FileBoxComponent {
    ...
    doFunction(event) {
        if (this.config.isFun) {
            if (this.config.inpFunction.type == _field_interface__WEBPACK_IMPORTED_MODULE_5__.FUNCTION_TYPE.TRIGGER) {
                this.globalFun[this.config.inpFunction.funName](this.group.getRawValue()[this.config.name], this.group.getRawValue());
            }
        }
    ...
    listenFunData() {
        if (this.config.isFun) {
            if (this.config.inpFunction.type == _field_interface__WEBPACK_IMPORTED_MODULE_5__.FUNCTION_TYPE.GETDATA) {
                this.unSub[0] = this.globalFun[this.config.inpFunction.funName + "Result"].subscribe((res) => {
                    this.group.controls[this.config.name].setValue(res);
                });
            }
...
FileBoxComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
...
MoterPrintComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.Component)({
...
"use strict";
module.exports = ".print-grid {\n  font-size: 0.75rem;\n}\n.field-col {\n  text-align: center;\n  padding: 5px 5px;\n  width: 100px;\n  font-size: 0.75rem;\n}\n.value-col {\n  padding: 5px 5px;\n  text-align: center;\n  width: 120px;\n  font-size: 0.75rem;\n}\n.title-style {\n  font-size: 0.9rem;\n}\ntable td {\n  border: 1px solid #9BC2E6;\n  border-collapse: collapse;\n}\n.print-header {\n  background-color: #f2f2f2;\n  margin: 0px;\n  padding: 15px 10px;\n  margin-bottom: 1.25rem;\n  position: relative;\n}\n.header-title {\n  display: flex;\n  align-items: center;\n  font-size: 0.9rem;\n  font-weight: bold;\n  color: #005f99;\n  position: absolute;\n}\n.header-title .logo {\n  width: 40px;\n  margin-right: 10px;\n}\n.product-name {\n  font-size: 1.5rem;\n  font-weight: bold;\n  width: 100%;\n  text-align: center;\n}\n.print-footer {\n  display: flex;\n  padding: 5px;\n  border-top: 1px solid #9BC2E6;\n}\n.print-footer .logo {\n  width: 40px;\n  margin-right: 10px;\n}\n.qr {\n  position: absolute;\n  right: 10px;\n  top: 15px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
"use strict";
module.exports = ".sign-row {\n  display: flex;\n  justify-content: space-between;\n  margin-top: 15px;\n  font-size: 0.9rem;\n}\n.sign-row .sign-area {\n  width: 150px;\n  height: 30px;\n  border-bottom: 1px #000 dashed;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
