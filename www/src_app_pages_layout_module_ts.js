...
/* harmony import */ var _core_menu_data_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../core/menu-data.service */ 17606);
...
let AsideDynamicComponent = class AsideDynamicComponent {
    constructor(layout, router, menu, menuService, auth, cdr) {
        this.layout = layout;
        this.router = router;
        this.menu = menu;
    ...
    ngOnInit() {
        ...
        const routerSubscr = this.router.events.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.filter)(event => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_6__.NavigationEnd)).subscribe((event) => {
...
AsideDynamicComponent.ctorParameters = () => [
    ...
    { type: _core_menu_data_service__WEBPACK_IMPORTED_MODULE_2__.MenuDataService },
    { type: _modules_auth__WEBPACK_IMPORTED_MODULE_3__.AuthService },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_7__.ChangeDetectorRef }
];
AsideDynamicComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
