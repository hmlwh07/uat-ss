...
let ActivityManagementDetailComponent = class ActivityManagementDetailComponent {
    constructor(route, modalService, activityManageService, location, cdf) {
        this.route = route;
    ...
    loadForm(oldData) {
        ...
        this.actForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormGroup({
            "activityNo": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl({ value: oldData ? oldData.activityNo : null, disabled: true }),
            "activityType": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(oldData ? oldData.activityType : '', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required),
            "activityTitle": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(oldData ? oldData.activityTitle : null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required),
            "activityDescription": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(oldData ? oldData.activityDescription : null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required),
            "planDateStr": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(oldData && oldData.planDate ? moment__WEBPACK_IMPORTED_MODULE_4__(oldData.planDate) : null),
            "actualDateStr": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(oldData && oldData.actualDate ? moment__WEBPACK_IMPORTED_MODULE_4__(oldData.actualDate) : null),
            "dueDateStr": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(oldData && oldData.dueDate ? moment__WEBPACK_IMPORTED_MODULE_4__(oldData.dueDate) : null),
            "relatedTo": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl({ value: oldData ? oldData.relatedTo : null, disabled: true }),
            "customerId": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(oldData ? oldData.customerId : null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required),
            "customerName": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl({ value: oldData ? oldData.customerName : null, disabled: true }),
            "assignTo": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(oldData ? oldData.assignTo : null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required),
            "assignName": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl({ value: oldData ? oldData.assignName : null, disabled: true }),
            "status": new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl({ value: oldData ? oldData.status : "01", disabled: oldData ? false : true }),
        });
...
ActivityManagementDetailComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_13__.__decorate)([
