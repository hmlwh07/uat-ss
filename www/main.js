...
let AppComponent = class AppComponent {
    constructor(splashScreenService, router, tableService, itemService, kbzToast, master, authService, zone, applicationRef, alertCtrl, alertService, menuService, modalCtrl, loadingService, messagingService, userTokenService, langageService, auth, plat) {
        this.splashScreenService = splashScreenService;
        this.router = router;
    ...
    ngOnInit() {
        ...
        const routerSubscription = this.router.events.subscribe((event) => {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_19__.NavigationEnd) {
        ...
        this.plat.ready().then((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_18__.__awaiter)(this, void 0, void 0, function* () {
    ...
    listenForMessages() {
        this.messagingService.getMessages().subscribe((msg) => (0,tslib__WEBPACK_IMPORTED_MODULE_18__.__awaiter)(this, void 0, void 0, function* () {
            if (msg) {
                console.log(msg);
...
AppComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_18__.__decorate)([
...
"use strict";
module.exports = ".mat-paginator-container {\n  justify-content: space-between;\n}\n\n.label.label-custom-round {\n  line-height: 20px;\n  white-space: nowrap;\n  border-radius: 10px;\n  min-width: 80px;\n  color: white;\n}\n\n.table-img {\n  max-width: 50px;\n  max-height: 50px;\n}\n\n.label-default {\n  color: black !important;\n}\n\n.act-btn-box {\n  padding: 0px 10px;\n  background-color: #005f99;\n  border-color: #005f99;\n  color: #fff !important;\n  text-decoration: none;\n  padding: 0.35rem 0.75rem;\n  font-size: 0.925rem;\n  line-height: 1.35;\n  border-radius: 0.42rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
