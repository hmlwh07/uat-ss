...
/* harmony import */ var _firebase_app__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @firebase/app */ 98770);
...
function _migrateOldDatabase() {
  _migrateOldDatabase = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (senderId) {
    ...
    const db = yield (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.openDB)(OLD_DB_NAME, OLD_DB_VERSION, /*#__PURE__*/function () {
      var _ref = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (db, oldVersion, newVersion, upgradeTransaction) {
        var _a;
    ...
    yield (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.deleteDB)(OLD_DB_NAME);
    yield (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.deleteDB)('fcm_vapid_details_db');
    yield (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.deleteDB)('undefined');
...
function getDbPromise() {
  if (!dbPromise) {
    dbPromise = (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.openDB)(DATABASE_NAME, DATABASE_VERSION, (upgradeDb, oldVersion) => {
...
function _dbGet() {
  _dbGet = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies) {
...
function _dbSet() {
  _dbSet = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, tokenDetails) {
    const key = getKey(firebaseDependencies);
    const db = yield getDbPromise();
...
function _dbRemove() {
  _dbRemove = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies) {
    const key = getKey(firebaseDependencies);
    const db = yield getDbPromise();
    const tx = db.transaction(OBJECT_STORE_NAME, 'readwrite');
...
function _requestGetToken() {
  _requestGetToken = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, subscriptionOptions) {
...
function _requestUpdateToken() {
  _requestUpdateToken = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, tokenDetails) {
    const headers = yield getHeaders(firebaseDependencies);
...
function _requestDeleteToken() {
  _requestDeleteToken = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, token) {
    const headers = yield getHeaders(firebaseDependencies);
...
function _getHeaders() {
  _getHeaders = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* ({
    appConfig,
    installations
  }) {
...
function _getTokenInternal() {
  _getTokenInternal = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging) {
...
function _deleteTokenInternal() {
  _deleteTokenInternal = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging) {
    const tokenDetails = yield dbGet(messaging.firebaseDependencies);
...
function _updateToken() {
  _updateToken = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging, tokenDetails) {
    try {
...
function _getNewToken() {
  _getNewToken = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (firebaseDependencies, subscriptionOptions) {
...
function _getPushSubscription() {
  _getPushSubscription = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (swRegistration, vapidKey) {
...
function _stageLog() {
  _stageLog = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (messaging, internalPayload) {
...
function _onSubChange() {
  _onSubChange = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, messaging) {
    var _a, _b;
...
function _onPush() {
  _onPush = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, messaging) {
...
function _onNotificationClick() {
  _onNotificationClick = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event) {
    var _a, _b;
...
function _getWindowClient() {
  _getWindowClient = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url) {
    const clientList = yield getClientList();
...
function registerMessagingInSw() {
  (0,_firebase_app__WEBPACK_IMPORTED_MODULE_4__._registerComponent)(new _firebase_component__WEBPACK_IMPORTED_MODULE_2__.Component('messaging-sw', SwMessagingFactory, "PUBLIC"
  /* PUBLIC */
  ));
}
/**
...
function _isSwSupported() {
  _isSwSupported = (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    // firebase-js-sdk/issues/2393 reveals that idb#open in Safari iframe and Firefox private browsing
    // might be prohibited to run. In these contexts, an error would be thrown during the messaging
    // instantiating phase, informing the developers to import/call isSupported for special handling.
    return (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.isIndexedDBAvailable)() && (yield (0,_firebase_util__WEBPACK_IMPORTED_MODULE_3__.validateIndexedDBOpenable)()) && 'PushManager' in self && 'Notification' in self && ServiceWorkerRegistration.prototype.hasOwnProperty('showNotification') && PushSubscription.prototype.hasOwnProperty('getKey');
  });
  return _isSwSupported.apply(this, arguments);
}
...
class MessagingCompatImpl {
  ...
  getToken(options) {
    ...
    return (0,D_03_mobile_app_09_kbz_ms_mobile_bss_kbzms_sales_app_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
