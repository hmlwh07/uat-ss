...
let LeadDetailComponent = class LeadDetailComponent {
    ...
    getState() {
        return this.masterDataService
            .getDataByType("STATE", true).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_31__.map)(x => this.getFormatOpt(x)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_32__.catchError)(e => {
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_33__.of)([]);
        }));
        // .toPromise()
        // .then((res: any) => {
    ...
    calculateScore(code) {
        ...
        let channel = this.leadForm.getRawValue().channelCode;
        if (source && channel) {
            this.LeadDetailService.getLeadScore(source.code, channel).toPromise().then((res) => {
    ...
    loadForm(oldData) {
        ...
        this.leadForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_35__.FormGroup({
            ...
            identityType: new _angular_forms__WEBPACK_IMPORTED_MODULE_35__.FormControl({ value: oldData ? oldData.identityType : '', disabled: true }),
            ...
            identityNumber: new _angular_forms__WEBPACK_IMPORTED_MODULE_35__.FormControl({ value: oldData ? oldData.identityNumber : '', disabled: true }),
    ...
    deleteFNA(id) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_34__.__awaiter)(this, void 0, void 0, function* () {
            this.alertService.activate('Are you sure you want to delete?', 'Warning Message').then((result) => (0,tslib__WEBPACK_IMPORTED_MODULE_34__.__awaiter)(this, void 0, void 0, function* () {
                if (result) {
...
module.exports = ".input-group .form-control-sm {\n  background-color: #ffffff;\n  background-clip: padding-box;\n  border: 1px solid #E4E6EF;\n  padding: 0px 0.75rem;\n}\n.input-group .mat-datepicker-toggle {\n  position: absolute;\n  right: 5px;\n  top: -2px;\n}\n.readonly {\n  background-color: #9c9999 !important;\n  color: #ffffff;\n}\n.tab {\n  overflow: hidden;\n  border: 1px solid #ccc;\n  background-color: #f1f1f1;\n}\n/* Style the buttons that are used to open the tab content */\n.tab button {\n  background-color: inherit;\n  float: left;\n  border: none;\n  outline: none;\n  cursor: pointer;\n  padding: 14px 16px;\n  transition: 0.3s;\n}\n/* Change background color of buttons on hover */\n.tab button:hover {\n  background-color: #ddd;\n}\n/* Create an active/current tablink class */\n.tab button.active {\n  background-color: #ccc;\n}\n/* Style the tab content */\n.active {\n  display: block;\n}\n.inactive {\n  display: none;\n}\n.icon {\n  position: relative;\n  border: none;\n  margin: 0;\n  font-size: 1.5rem;\n  background-color: transparent;\n}\n.add {\n  top: -11px;\n  position: relative;\n  border: none;\n  background: #f2f2f2;\n  margin: 0;\n}\n.add button {\n  position: absolute;\n  top: -52px;\n  right: 78px;\n  width: 110px;\n}\nh2 {\n  font-size: 13px;\n  color: #005ca2;\n  background: #F2F2F2;\n  border: none;\n  cursor: pointer;\n  position: relative;\n  margin-top: 24px;\n  padding: 12px 24px 1px 24px;\n}\nh2 span {\n  position: absolute;\n  right: 14px;\n  top: 5px;\n}\nh2 img {\n  width: 6px;\n  height: 12px;\n  float: left;\n}\nh2 p {\n  font-size: 12px;\n  padding-left: 18px;\n}\n.btn-box {\n  text-align: end;\n}\n.btn-box input {\n  position: absolute;\n  width: 127%;\n  height: 100%;\n  opacity: 0;\n}\n.checkgroup,\n.check-input {\n  display: flex;\n  grid-gap: 10px;\n  gap: 10px;\n  align-items: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
