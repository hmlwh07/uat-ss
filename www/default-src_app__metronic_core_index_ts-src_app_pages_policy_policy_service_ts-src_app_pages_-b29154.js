...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PolicyManageService": () => (/* binding */ PolicyManageService),
...
const API_QUOTATION_URL = `${_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.apiUrl}/policy/page`;
const API_QUOTATION__ATT_URL = `${_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.apiUrl}/policy`;
let PolicyService = class PolicyService extends _core_biz_operation_service__WEBPACK_IMPORTED_MODULE_2__.BizOperationService {
    ...
    updateAttachment(resId, attId, signDate) {
...
let PolicyManageService = class PolicyManageService extends _core_biz_operation_service__WEBPACK_IMPORTED_MODULE_2__.BizOperationService {
    constructor(httpClient) {
        super(httpClient, API_QUOTATION__ATT_URL);
        this.httpClient = httpClient;
    }
};
PolicyManageService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__.HttpClient }
];
PolicyManageService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Injectable)({
        providedIn: 'root'
    })
], PolicyManageService);
...
const API_AGENT_URL = `${_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/dashboard/agent`;
let ProductDataService = class ProductDataService extends _core_biz_operation_service__WEBPACK_IMPORTED_MODULE_1__.BizOperationService {
    constructor(httpClient) {
        ...
        this._totalPremium = 0;
        this._totalPremiumView = 0;
    }
    getAll(showInList) {
    ...
    get totalPremiumView() {
        return this._totalPremiumView;
    }
    set totalPremiumView(value) {
