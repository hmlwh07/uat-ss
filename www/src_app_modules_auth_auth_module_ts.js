...
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_auth_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./auth.component.html */ 37015);
...
AuthComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Component)({
        selector: 'app-auth',
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_auth_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony import */ var _languages_languages_modules__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../languages/languages.modules */ 63699);
...
AuthModule = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_8__.NgModule)({
        ...
        imports: [
            ...
            _languages_languages_modules__WEBPACK_IMPORTED_MODULE_6__.LanguageModule,
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 98806);
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_forgot_password_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./forgot-password.component.html */ 78444);
...
ForgotPasswordComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_forgot_password_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_login_component_new_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./login.component-new.html */ 45655);
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rxjs */ 49566);
...
/* harmony import */ var _languages_languages_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../languages/languages.service */ 59832);
...
let LoginComponent = class LoginComponent {
    constructor(fb, authService, route, router, translate, menuDataService) {
        this.fb = fb;
        this.authService = authService;
        this.route = route;
        this.router = router;
    ...
    submit() {
        ...
        const loginSubscr = this.authService
            ...
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.first)(), (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.mergeMap)((x) => {
            return this.menuDataService.getMenusData().pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_7__.mergeMap)((data) => {
                return (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.of)(x);
            }));
        }))
            .subscribe((user) => {
            if (user) {
...
LoginComponent.ctorParameters = () => [
    ...
    { type: _languages_languages_service__WEBPACK_IMPORTED_MODULE_3__.LanguagesService },
    { type: _core_menu_data_service__WEBPACK_IMPORTED_MODULE_4__.MenuDataService }
];
LoginComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_11__.Component)({
        selector: 'app-login',
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_login_component_new_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_logout_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./logout.component.html */ 96108);
...
LogoutComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
        selector: 'app-logout',
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_logout_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony import */ var _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_registration_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./registration.component.html */ 23663);
...
RegistrationComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_9__.Component)({
        ...
        template: _Users_khanttikyi_Workspace_BSS_bss_kbzms_sales_app_node_modules_ngtools_webpack_src_loaders_direct_resource_js_registration_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
module.exports = ":host {\n  width: 100%;\n}\n@media (min-width: 992px) {\n  :host .login-form {\n    width: 100%;\n    max-width: 450px;\n  }\n  :host .login-form .mat-form-field {\n    width: 100%;\n  }\n}\n.logo-text {\n  margin-top: 10px;\n  font-size: 30px;\n  color: #fff;\n  font-weight: bold;\n  line-height: 20px;\n  display: block;\n  letter-spacing: 1px;\n}\n.logo-text small {\n  font-size: 15px;\n  letter-spacing: 0px;\n}\n.input-icons i {\n  position: absolute;\n  font-size: 2.5rem;\n  padding: 0px 7px;\n}\n.input-icons {\n  width: 100%;\n}\n.icon {\n  min-width: 50px;\n}\n.card-body {\n  padding: 30px 15px;\n}\n.input-field {\n  width: 100%;\n  padding: 20px;\n  text-align: center;\n}\n::-webkit-input-placeholder {\n  text-align: center;\n}\n:-moz-placeholder {\n  /* Firefox 18- */\n  text-align: center;\n}\n::-moz-placeholder {\n  /* Firefox 19+ */\n  text-align: center;\n}\n:-ms-input-placeholder {\n  text-align: center;\n}\n.btn.btn-new {\n  background-color: #005f99;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
