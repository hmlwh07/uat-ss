...
/* harmony import */ var _add_form_currency_add_form_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./add-form/currency-add-form.component */ 68279);
/* harmony import */ var _currency_exchange_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./currency-exchange.service */ 19113);
/* harmony import */ var _currency_const__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./currency.const */ 27498);
...
let CurrencyExChangeComponent = class CurrencyExChangeComponent {
    constructor(currencyService, cdf, modalCrl) {
        this.currencyService = currencyService;
        this.cdf = cdf;
        this.modalCrl = modalCrl;
        this.currencyList = [];
        this.ELEMENT_COL = JSON.parse(JSON.stringify(_currency_const__WEBPACK_IMPORTED_MODULE_6__.CurrencyCol));
        this.displayedColumns = JSON.parse(JSON.stringify(_currency_const__WEBPACK_IMPORTED_MODULE_6__.CurrencyDisplayCol));
    }
    ngOnInit() {
        this.loadForm();
        this.getData();
    ...
    // }
    loadForm() {
        this.exchangeForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormGroup({
            date: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(null),
            currency: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl(null),
        });
    }
    getData() {
    ...
    addData() {
        const modalRef = this.modalCrl.open(_add_form_currency_add_form_component__WEBPACK_IMPORTED_MODULE_4__.CurrencyAddFormComponent, { size: 'md', backdrop: false });
...
CurrencyExChangeComponent.ctorParameters = () => [
    { type: _currency_exchange_service__WEBPACK_IMPORTED_MODULE_5__.CurrencyExchangeService },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_8__.ChangeDetectorRef },
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__.NgbModal }
];
CurrencyExChangeComponent.propDecorators = {
    matTable: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_8__.ViewChild, args: [_metronic_shared_crud_table_components_material_table_view_material_table_view_component__WEBPACK_IMPORTED_MODULE_3__.MaterialTableViewComponent,] }]
};
CurrencyExChangeComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
