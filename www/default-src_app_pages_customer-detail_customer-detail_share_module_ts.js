...
let CustomerDetailComponent = class CustomerDetailComponent {
    constructor(fb, location, masterDataService, route, customerService, modalService, cdf, prodctService, router, AttachmentUploadService, CustomerAttachmentService, AttachmentDownloadService, alertService, menuService, ngbModal) {
        this.fb = fb;
    ...
    loadForm(oldData) {
        ...
        this.customerForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_23__.FormGroup({
            ...
            "email": new _angular_forms__WEBPACK_IMPORTED_MODULE_23__.FormControl({ value: oldData ? oldData.email : '', disabled: disabledForm }),
            ...
            "houseNumber": new _angular_forms__WEBPACK_IMPORTED_MODULE_23__.FormControl({ value: oldData ? oldData.houseNumber : '', disabled: disabledForm }),
            "road": new _angular_forms__WEBPACK_IMPORTED_MODULE_23__.FormControl({ value: oldData ? oldData.road : '', disabled: disabledForm }),
            "blockArea": new _angular_forms__WEBPACK_IMPORTED_MODULE_23__.FormControl({ value: oldData ? oldData.blockArea : '', disabled: disabledForm }),
        ...
        this.customerService.save(data).toPromise().then((res) => {
            ...
            if (res) {
                if (this.isPopup) {
                    ...
                    this.ngbModal.dismiss({ data: Object.assign(Object.assign({}, postData), { name: name, customerId: res }), type: "save" });
                }
                else {
...
CustomerDetailComponent.ctorParameters = () => [
    ...
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_27__.NgbActiveModal }
];
...
let ProductsComponent = class ProductsComponent {
    ...
    getProducts() {
        this.itemService.getAll(this.isShowList).toPromise().then((res) => {
            //console.log(res);
            if (res) {
                this.products = res;
                this.cdRef.detectChanges();
...
ProductsComponent.propDecorators = {
    ...
    isShowList: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_9__.Input }]
};
...
module.exports = ".upload-icon-group {\n  display: flex;\n  gap: 10px;\n}\n\n.upload-icon {\n  display: flex;\n  align-items: center;\n  width: 100px;\n  height: 100px;\n  border: 1px dashed #333;\n  flex-direction: column;\n  justify-content: center;\n  gap: 5px;\n  border-radius: 10px;\n  overflow: hidden;\n}\n\n.upload-icon img {\n  width: 100px;\n  height: 100px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
