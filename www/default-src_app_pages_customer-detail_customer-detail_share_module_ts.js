...
/* harmony import */ var _Users_casperakm_Work_Bss_KBZ_SALE_node_modules_ngtools_webpack_src_loaders_direct_resource_js_customer_detail_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./customer-detail.component.html */ 10257);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! rxjs/operators */ 2014);
...
/* harmony import */ var src_app_modules_master_data_master_data_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/modules/master-data/master-data.service */ 26697);
...
/* harmony import */ var _activity_management_list_activity_manage_const__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../activity-management-list/activity-manage.const */ 63703);
/* harmony import */ var _fna_list_fna_list_const__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../fna-list/fna.list.const */ 63871);
/* harmony import */ var _form_component_custom_input_alert_custom_input_alert_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../form-component/custom-input-alert/custom-input-alert.component */ 91471);
/* harmony import */ var _form_component_nrc_popup_nrc_popup_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../form-component/nrc-popup/nrc-popup.page */ 69523);
/* harmony import */ var _lead_detail_FNA_list_const__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../lead-detail/FNA-list.const */ 73155);
/* harmony import */ var _policy_list_policy_const__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../policy/list/policy.const */ 76175);
/* harmony import */ var _products_products_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../products/products.component */ 55099);
/* harmony import */ var _products_services_products_data_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../products/services/products-data.service */ 35618);
/* harmony import */ var _quotations_list_quotation_const__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../quotations/list/quotation.const */ 17318);
/* harmony import */ var _customer_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./customer.service */ 27738);
...
let CustomerDetailComponent = class CustomerDetailComponent {
    constructor(fb, location, masterDataService, route, customerService, modalService, cdf, prodctService, router, AttachmentUploadService, CustomerAttachmentService, AttachmentDownloadService) {
        this.fb = fb;
        ...
        this.FNAELEMENT_COL = JSON.parse(JSON.stringify(_fna_list_fna_list_const__WEBPACK_IMPORTED_MODULE_8__.FNAListCol));
        this.FNAdisplayedColumns = JSON.parse(JSON.stringify(_lead_detail_FNA_list_const__WEBPACK_IMPORTED_MODULE_11__.FNADisplayCol));
        this.ACTIVITY_ELEMENT_COL = JSON.parse(JSON.stringify(_activity_management_list_activity_manage_const__WEBPACK_IMPORTED_MODULE_7__.ActivityCol));
        this.ACTIVITYdisplayedColumns = JSON.parse(JSON.stringify(_activity_management_list_activity_manage_const__WEBPACK_IMPORTED_MODULE_7__.ActivityDisplayCol));
        this.QUOTATION_ELEMENT_COL = JSON.parse(JSON.stringify(_quotations_list_quotation_const__WEBPACK_IMPORTED_MODULE_15__.QuotationCol));
        this.QuotationdisplayedColumns = JSON.parse(JSON.stringify(_quotations_list_quotation_const__WEBPACK_IMPORTED_MODULE_15__.QuoDisplayCol));
        this.APPLICATION_ELEMENT_COL = JSON.parse(JSON.stringify(_policy_list_policy_const__WEBPACK_IMPORTED_MODULE_12__.PolicyCol));
        this.ApplicationdisplayedColumns = JSON.parse(JSON.stringify(_policy_list_policy_const__WEBPACK_IMPORTED_MODULE_12__.PolicyDisplayCol));
        this.ATTACHMENT_ELEMENT_COL = JSON.parse(JSON.stringify(_lead_detail_FNA_list_const__WEBPACK_IMPORTED_MODULE_11__.AttachmentCol));
        this.AttachmentdisplayedColumns = JSON.parse(JSON.stringify(_lead_detail_FNA_list_const__WEBPACK_IMPORTED_MODULE_11__.AttachmentDisplayCol));
    ...
    getNationality() {
        this.masterDataService.getDataByType("NATIONALITY").pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.map)(x => this.getFormatOpt(x))).toPromise().then((res) => {
            if (res) {
    ...
    getTitle() {
        this.masterDataService.getDataByType("TITLE").pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.map)(x => this.getFormatOpt(x))).toPromise().then((res) => {
            if (res) {
    ...
    getGender() {
        this.masterDataService.getDataByType("TB_GENDER").pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.map)(x => this.getFormatOpt(x))).toPromise().then((res) => {
            if (res) {
    ...
    getOccupation() {
        this.masterDataService.getDataByType("OCCUPATION").pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.map)(x => this.getFormatOpt(x))).toPromise().then((res) => {
            if (res) {
    ...
    getStatus() {
        this.masterDataService.getDataByType("CUST_STATUS").pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.map)(x => this.getFormatOpt(x))).toPromise().then((res) => {
            if (res) {
    ...
    getState() {
        this.masterDataService.getDataByType("STATE", true).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.map)(x => this.getFormatOpt(x))).toPromise().then((res) => {
            if (res) {
    ...
    getDistrict(parentId) {
        this.masterDataService.getAddressDataByType("DISTRICT", parentId).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.map)(x => this.getFormatOpt(x))).toPromise().then((res) => {
            if (res) {
    ...
    getTownship(parentId) {
        this.masterDataService.getAddressDataByType("TOWNSHIP", parentId).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.map)(x => this.getFormatOpt(x))).toPromise().then((res) => {
            if (res) {
    ...
    loadForm(oldData) {
        ...
        this.cdf.detectChanges();
        this.customerForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormGroup({
            "titleCode": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.titleCode : '', disabled: disabledForm }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "firstName": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.firstName : '', disabled: disabledForm }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "lastName": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.lastName : '', disabled: disabledForm }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "middleName": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.middleName : '', disabled: disabledForm }),
            "genderCode": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.genderCode : '', disabled: disabledForm }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "nationalityCode": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.nationalityCode : '', disabled: disabledForm }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "identityType": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.identityType : '', disabled: disabledForm }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "identityNumber": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.identityNumber : '', disabled: disabledForm }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "statusCode": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.statusCode : 'A', disabled: disabledForm || this.isLead }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "partyCode": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.partyCode : '', disabled: disabledForm }),
            "fatherName": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.fatherName : '', disabled: disabledForm }),
            "phone": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.phone : '', disabled: disabledForm }, [_angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.maxLength(11), _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.minLength(9)]),
            "email": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.email : '', disabled: disabledForm }, [_angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.email, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required]),
            "dateOfBirth": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: !oldData ? null : oldData.dateOfBirth ? moment__WEBPACK_IMPORTED_MODULE_2__(oldData.dateOfBirth) : null, disabled: disabledForm, }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "occupationCode": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.occupationCode : '', disabled: disabledForm }),
            "houseNumber": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.houseNumber : '', disabled: disabledForm }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "road": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.road : '', disabled: disabledForm }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "blockArea": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.blockArea : '', disabled: disabledForm }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "townshipCode": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.townshipCode : '', disabled: disabledForm }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "districtCode": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.districtCode : '', disabled: disabledForm }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "stateCode": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: oldData ? oldData.stateCode : '', disabled: disabledForm }, _angular_forms__WEBPACK_IMPORTED_MODULE_18__.Validators.required),
            "companyName": new _angular_forms__WEBPACK_IMPORTED_MODULE_18__.FormControl({ value: 'IKBZG', disabled: true })
        });
    }
    clearDOB(type) {
        if (type == 'dateOfBirth') {
    ...
    openModal() {
        let modalRef;
        modalRef = this.modalService.open(_form_component_nrc_popup_nrc_popup_page__WEBPACK_IMPORTED_MODULE_10__.NrcPopupPage, { size: 'xl', backdrop: false });
    ...
    addAttachment() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_19__.__awaiter)(this, void 0, void 0, function* () {
            let modalRef;
            modalRef = this.modalService.open(_form_component_custom_input_alert_custom_input_alert_component__WEBPACK_IMPORTED_MODULE_9__.CustomInputAlertComponent, { size: 'lg', backdrop: false });
...
CustomerDetailComponent.ctorParameters = () => [
    ...
    { type: src_app_modules_master_data_master_data_service__WEBPACK_IMPORTED_MODULE_4__.MasterDataService },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_21__.ActivatedRoute },
    { type: _customer_service__WEBPACK_IMPORTED_MODULE_16__.CustomerService },
    ...
    { type: src_app_metronic_core_services_attachment_data_service__WEBPACK_IMPORTED_MODULE_5__.AttachmentUploadService },
    { type: src_app_metronic_core_services_attachment_data_service__WEBPACK_IMPORTED_MODULE_5__.AttachmentServiceRef },
...
CustomerDetailComponent.propDecorators = {
    fnamatTable: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_23__.ViewChild, args: ['fna',] }],
    activitymatTable: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_23__.ViewChild, args: ['activity',] }],
    applicationmatTable: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_23__.ViewChild, args: ['application',] }],
    attachmentmatTable: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_23__.ViewChild, args: ['attachment',] }],
    quotationmatTable: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_23__.ViewChild, args: ['quotation',] }],
    isPopup: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_23__.Input }],
    pageStatus: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_23__.Input }],
    isLead: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_23__.Input }]
};
CustomerDetailComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_19__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_23__.Component)({
        selector: 'app-customer-detail',
        template: _Users_casperakm_Work_Bss_KBZ_SALE_node_modules_ngtools_webpack_src_loaders_direct_resource_js_customer_detail_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        providers: [
            ...
            { provide: _angular_material_core__WEBPACK_IMPORTED_MODULE_24__.MAT_DATE_FORMATS, useValue: _core_is_json__WEBPACK_IMPORTED_MODULE_6__.MY_FORMATS },
        ],
...
/* harmony import */ var _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/material/datepicker */ 21349);
...
CustomerDetailShareModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
module.exports = ".input-group .form-control-sm {\n  background-color: #ffffff;\n  background-clip: padding-box;\n  border: 1px solid #E4E6EF;\n  padding: 0px 0.75rem;\n}\n.input-group .mat-datepicker-toggle {\n  position: absolute;\n  right: 5px;\n}\n.active {\n  display: block;\n}\n.inactive {\n  display: none;\n}\n.icon {\n  position: relative;\n  border: none;\n  margin: 0;\n  font-size: 1.5rem;\n}\n.add {\n  top: -11px;\n  position: relative;\n  border: none;\n  background: #f2f2f2;\n  margin: 0;\n}\n.add button {\n  position: absolute;\n  top: -52px;\n  right: 78px;\n  width: 110px;\n}\n.btn-box {\n  text-align: end;\n}\n.btn-box input {\n  position: absolute;\n  width: 127%;\n  height: 100%;\n  opacity: 0;\n}\nh2 {\n  font-size: 13px;\n  color: #005ca2;\n  background: #F2F2F2;\n  border: none;\n  cursor: pointer;\n  position: relative;\n  margin-top: 24px;\n  padding: 12px 24px 1px 24px;\n}\nh2 span {\n  position: absolute;\n  right: 14px;\n  top: 5px;\n}\nh2 img {\n  width: 6px;\n  height: 12px;\n  float: left;\n}\nh2 p {\n  font-size: 12px;\n  padding-left: 18px;\n}\n.tab-div {\n  position: relative;\n  padding: 20px 0 0 0;\n  background: #d1d7e2;\n  border-bottom: 1px solid #d2d2d2;\n  margin: -10px 0 0 0;\n}\n.tab-div button {\n  position: absolute;\n  bottom: 20px;\n  right: 20px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
