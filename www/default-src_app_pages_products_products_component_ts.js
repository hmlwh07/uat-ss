...
/* harmony import */ var _services_products_data_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../services/products-data.service */ 35618);
...
let ProductsModalComponent = class ProductsModalComponent {
    ...
    loadForm() {
        this.formGroup = this.fb.group({
            productName: [this.oldData.name || null, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.nullValidator])],
            productCode: [this.oldData.code || null, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.nullValidator])],
            type: [this.oldData.type || 'GENERAL', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.nullValidator])],
            stamDuty: [this.oldData.stamDuty || false, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.nullValidator])],
            isAllowBackDate: [this.oldData.isAllowBackDate || null, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.nullValidator])],
            allowDays: [this.oldData.allowDays || null],
            ruleDate: [this.oldData.quotationDay || null, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.nullValidator])],
            ruleType: [this.oldData.quotationRule || null, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.nullValidator])],
            policyDay: [this.oldData.policyDay || null, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.nullValidator])],
            policyRule: [this.oldData.policyRule || null, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.nullValidator])],
            statusCd: [this.oldData.statusCd || "02", _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.nullValidator])],
...
ProductsModalComponent.ctorParameters = () => [
    ...
    { type: _services_products_data_service__WEBPACK_IMPORTED_MODULE_6__.ProductDataService },
...
ProductsModalComponent.propDecorators = {
    selectedFileEl: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_9__.ViewChild, args: ['selectedFile',] }],
    selectedFileEl2: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_9__.ViewChild, args: ['selectedFile2',] }]
};
ProductsModalComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
