...
/* harmony import */ var _signature_pad_signature_pad_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./signature-pad/signature-pad.component */ 10830);
...
let ResourseDetailComponent = class ResourseDetailComponent {
    constructor(productService, location, pageDataService, addonQuo, coverageQuo, router, cdf, downloadService, numberPipe, datePipe, modalService, policyService, alertService) {
    ...
    createSign() {
        const modalRef = this.modalService.open(_signature_pad_signature_pad_component__WEBPACK_IMPORTED_MODULE_12__.SignaturePadComponent, { size: 'md', backdrop: false });
        modalRef.result.then(() => { }, (res) => {
            if (res) {
                if (res.type == "save") {
...
ResourseDetailComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_13__.__decorate)([
...
module.exports = ".top-box {\n  color: #B5B5C3;\n  margin-left: 50px;\n}\n.top-box span {\n  color: #000;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
