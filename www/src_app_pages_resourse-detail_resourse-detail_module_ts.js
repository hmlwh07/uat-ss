...
/* harmony import */ var _print_preview_modal_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./print-preview-modal.component.html?ngResource */ 27925);
/* harmony import */ var _print_preview_modal_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./print-preview-modal.component.scss?ngResource */ 827);
...
PrintPreviewModalComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Component)({
        ...
        template: _print_preview_modal_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_print_preview_modal_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
...
/* harmony import */ var _resourse_detail_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./resourse-detail.component.html?ngResource */ 70585);
/* harmony import */ var _resourse_detail_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./resourse-detail.component.scss?ngResource */ 57256);
...
/* harmony import */ var _metronic_core_services_attachment_data_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../_metronic/core/services/attachment-data.service */ 56289);
/* harmony import */ var _check_parent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../check-parent */ 94936);
/* harmony import */ var _policy_policy_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../policy/policy.service */ 61106);
/* harmony import */ var _product_form_page_data_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../product-form/page-data.service */ 41070);
/* harmony import */ var _products_models_product_dto__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../products/models/product.dto */ 79611);
/* harmony import */ var _products_print_preview_modal_print_preview_modal_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../products/print-preview-modal/print-preview-modal.component */ 14023);
...
/* harmony import */ var _signature_pad_signature_pad_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./signature-pad/signature-pad.component */ 10830);
...
let ResourseDetailComponent = class ResourseDetailComponent {
    constructor(productService, location, pageDataService, router, cdf, downloadService, numberPipe, datePipe, modalService, policyService, alertService, masterDataService) {
    ...
    getOldData(oldData, tempFormData) {
        ...
        for (let element of this.pageOrder) {
            if (element.type == _products_models_product_dto__WEBPACK_IMPORTED_MODULE_8__.PageUIType.DYN) {
    ...
    checkDep(dependency, checkData) {
        if (dependency)
            return (0,_check_parent__WEBPACK_IMPORTED_MODULE_5__.checkVaidDep)(dependency, { value: checkData });
        return true;
    }
    ...
    viewPrint() {
        if (!this.selectedBranchCode) {
            ...
            const modalRef = this.modalService.open(_products_print_preview_modal_print_preview_modal_component__WEBPACK_IMPORTED_MODULE_9__.PrintPreviewModalComponent, { size: 'xl', backdrop: false });
    ...
    getBranch() {
        return this.masterDataService.getDataByType("CORE_BRANCH").pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_14__.map)(x => this.getFormatOpt(x)), (0,rxjs__WEBPACK_IMPORTED_MODULE_15__.catchError)(e => {
...
ResourseDetailComponent.ctorParameters = () => [
    ...
    { type: _product_form_page_data_service__WEBPACK_IMPORTED_MODULE_7__.PageDataService },
    ...
    { type: _metronic_core_services_attachment_data_service__WEBPACK_IMPORTED_MODULE_4__.AttachmentDownloadService },
    { type: _angular_common__WEBPACK_IMPORTED_MODULE_17__.DecimalPipe },
    { type: _angular_common__WEBPACK_IMPORTED_MODULE_17__.DatePipe },
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_20__.NgbModal },
    { type: _policy_policy_service__WEBPACK_IMPORTED_MODULE_6__.PolicyService },
...
ResourseDetailComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_19__.Component)({
        ...
        template: _resourse_detail_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_resourse_detail_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
...
/* harmony import */ var _resourse_detail_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./resourse-detail.component */ 10991);
...
/* harmony import */ var _static_page_review_static_pages_reivew_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../static-page-review/static-pages-reivew.module */ 72363);
/* harmony import */ var angular2_signaturepad__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! angular2-signaturepad */ 676);
/* harmony import */ var _signature_pad_signature_pad_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./signature-pad/signature-pad.component */ 10830);
...
ResourseDetailModule = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 34929);
/* harmony import */ var _signature_pad_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./signature-pad.component.html?ngResource */ 84338);
/* harmony import */ var _signature_pad_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./signature-pad.component.scss?ngResource */ 85700);
...
/* harmony import */ var angular2_signaturepad__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! angular2-signaturepad */ 676);
/* harmony import */ var src_app_modules_loading_toast_alert_model_alert_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/modules/loading-toast/alert-model/alert.service */ 25492);
/* harmony import */ var _metronic_core_services_attachment_data_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../_metronic/core/services/attachment-data.service */ 56289);
...
let SignaturePadComponent = class SignaturePadComponent {
    constructor(modal, fileUpload, alertService) {
        this.modal = modal;
...
SignaturePadComponent.ctorParameters = () => [
    ...
    { type: _metronic_core_services_attachment_data_service__WEBPACK_IMPORTED_MODULE_3__.AttachmentUploadService },
    { type: src_app_modules_loading_toast_alert_model_alert_service__WEBPACK_IMPORTED_MODULE_2__.AlertService }
];
SignaturePadComponent.propDecorators = {
    signaturePad: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_5__.ViewChild, args: [angular2_signaturepad__WEBPACK_IMPORTED_MODULE_6__.SignaturePad,] }]
};
SignaturePadComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
        selector: 'app-resourse-detail',
        template: _signature_pad_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_signature_pad_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
...
/***/ 827:
/*!**************************************************************************************************!*\
  !*** ./src/app/pages/products/print-preview-modal/print-preview-modal.component.scss?ngResource ***!
  \**************************************************************************************************/
/***/ ((module) => {

module.exports = ".modal-body {\n  padding: 0.8rem !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";

/***/ }),

/***/ 57256:
/*!*********************************************************************************!*\
  !*** ./src/app/pages/resourse-detail/resourse-detail.component.scss?ngResource ***!
  \*********************************************************************************/
/***/ ((module) => {
...
/***/ 85700:
/*!*********************************************************************************************!*\
  !*** ./src/app/pages/resourse-detail/signature-pad/signature-pad.component.scss?ngResource ***!
  \*********************************************************************************************/
/***/ ((module) => {
...
/* harmony import */ var signature_pad__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! signature_pad */ 22895);
