...
/* harmony import */ var _check_parent__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../check-parent */ 94936);
/* harmony import */ var _policy_policy_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../policy/policy.service */ 61106);
...
/* harmony import */ var _products_models_product_dto__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../products/models/product.dto */ 79611);
/* harmony import */ var _products_print_preview_modal_print_preview_modal_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../products/print-preview-modal/print-preview-modal.component */ 14023);
...
/* harmony import */ var _signature_pad_signature_pad_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./signature-pad/signature-pad.component */ 10830);
...
let ResourseDetailComponent = class ResourseDetailComponent {
    constructor(productService, location, pageDataService, router, cdf, downloadService, numberPipe, datePipe, modalService, policyService, alertService) {
    ...
    getOldData(oldData, tempFormData) {
        ...
        for (let element of this.pageOrder) {
            if (element.type == _products_models_product_dto__WEBPACK_IMPORTED_MODULE_7__.PageUIType.DYN) {
    ...
    checkDep(dependency, checkData) {
        if (dependency)
            return (0,_check_parent__WEBPACK_IMPORTED_MODULE_4__.checkVaidDep)(dependency, { value: checkData });
        return true;
    }
    ...
    viewPrint() {
        const modalRef = this.modalService.open(_products_print_preview_modal_print_preview_modal_component__WEBPACK_IMPORTED_MODULE_8__.PrintPreviewModalComponent, { size: 'xl', backdrop: false });
    ...
    createSign() {
        const modalRef = this.modalService.open(_signature_pad_signature_pad_component__WEBPACK_IMPORTED_MODULE_10__.SignaturePadComponent, { size: 'md', backdrop: false });
        modalRef.result.then(() => { }, (res) => {
            if (res) {
                if (res.type == "save") {
...
ResourseDetailComponent.ctorParameters = () => [
    ...
    { type: _metronic_core_services_attachment_data_service__WEBPACK_IMPORTED_MODULE_3__.AttachmentDownloadService },
    ...
    { type: _policy_policy_service__WEBPACK_IMPORTED_MODULE_5__.PolicyService },
    { type: src_app_modules_loading_toast_alert_model_alert_service__WEBPACK_IMPORTED_MODULE_2__.AlertService }
];
ResourseDetailComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
