...
let RenewManagementListComponent = class RenewManagementListComponent {
    ...
    getFileExt(fileName) {
        return this.attachmentDownloadService.get(this.downED + fileName).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_15__.catchError)(() => { return (0,rxjs__WEBPACK_IMPORTED_MODULE_16__.of)(null); }));
    }
    changeView(type) {
        if (type == 'team') {
            this.isTeam = true;
