...
let RenewManagementListComponent = class RenewManagementListComponent {
    ...
    constructor(fb, router, cdf, renewService, alertService, loadingService, attachmentDownloadService, prodctService) {
        ...
        this.downED = "/attachment-downloader/tcs/";
        this.loadForm();
    }
    ngOnInit() {
        this.getProduct();
    ...
    loadForm() {
        this.actForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormGroup({
            ...
            statusCode: new _angular_forms__WEBPACK_IMPORTED_MODULE_12__.FormControl("")
        });
    }
    ...
    download(fileName) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_13__.__awaiter)(this, void 0, void 0, function* () {
            ...
            this.attachmentDownloadService.getFile(this.downED + file).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.map)((x) => {
                return { data: x };
...
RenewManagementListComponent.propDecorators = {
    matTable: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_16__.ViewChild, args: [_metronic_shared_crud_table_components_material_table_view_material_table_view_component__WEBPACK_IMPORTED_MODULE_7__.MaterialTableViewComponent,] }]
};
