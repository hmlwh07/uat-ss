...
let LeadListComponent = class LeadListComponent {
    ...
    getList(limit = 5, offset = 1) {
        let postData = Object.assign(Object.assign({}, this.LeadForm.getRawValue()), { limit: 5, offset: offset });
    ...
    getDatabyPage(page) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_20__.__awaiter)(this, void 0, void 0, function* () {
            ...
            let postData = Object.assign(Object.assign({}, this.LeadForm.getRawValue()), { limit: 5, offset: page });
            this.totalPages = 0;
            this.postedData = postData;
            yield this.LeadListService.getLeadList(this.postedData).toPromise().then((res) => {
                if (res) {
                    this.LeadList = res.content;
                    this.totalElements = res.totalElements;
                    this.totalPages = res.totalPages;
...
const API_LEAD_URL = `${_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.apiUrl}/lead/pager`;
let LeadListService = class LeadListService {
    constructor(httpClient) {
        this.httpClient = httpClient;
    }
    getLeadList(search = {}, limit, offset) {
