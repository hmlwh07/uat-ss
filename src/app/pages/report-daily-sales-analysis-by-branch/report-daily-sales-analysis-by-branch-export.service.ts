...
const API_ADDON_URL = `${environment.apiUrl}/report/dailySalesAnalysis`;
...
export class ReportDailyDalesAnalysisBranchExportService extends BizOperationService<any, number>{
