...
export class CustomerDetailComponent implements OnInit, AfterViewInit {
  ...
  loadForm(oldData?) {
    ...
    this.customerForm = new FormGroup({
      ...
      "middleName": new FormControl({ value: oldData ? oldData.middleName : '', disabled: true },),
      ...
      "phone": new FormControl({ value: oldData ? oldData.phone : '', disabled: disabledForm }, [Validators.required, Validators.maxLength(12), Validators.minLength(9)]),
