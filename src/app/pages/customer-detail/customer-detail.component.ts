...
export class CustomerDetailComponent implements OnInit, AfterViewInit {
  ...
  loadForm(oldData?) {
    ...
    this.customerForm = new FormGroup({
      ...
      "email": new FormControl({ value: oldData ? oldData.email : '', disabled: disabledForm }, [Validators.required]),
      ...
      "houseNumber": new FormControl({ value: oldData ? oldData.houseNumber : '', disabled: disabledForm }),
      "road": new FormControl({ value: oldData ? oldData.road : '', disabled: disabledForm }),
      "blockArea": new FormControl({ value: oldData ? oldData.blockArea : '', disabled: disabledForm }),
