...
import { DISPLAY_COL, ELEMENT_COL } from './operation-others.const';

@Component({
  selector: 'app-operation-others',
  templateUrl: './operation-others.component.html',
  styleUrls: ['./operation-others.component.scss']
})
export class OperationOthersComponent implements OnInit {
