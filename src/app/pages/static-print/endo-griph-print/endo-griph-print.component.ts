...
@Component({
  ...
  templateUrl: './endo-griph-print.component.html',
  styleUrls: ['./endo-griph-print.component.scss']
})
export class EndoGripPrintComponent implements OnInit {
  ...
  createListData() {
    this.endoPayment.getMany(this.resourcesId).toPromise().then((res: any) => {
      // console.log(res);
      if (res) {
