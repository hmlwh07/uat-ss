...
@Component({
  ...
  templateUrl: './education-life-griph-print.component.html',
  styleUrls: ['./education-life-griph-print.component.scss']
})
export class EducationLifeGripPrintComponent implements OnInit {
