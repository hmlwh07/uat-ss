...
@Component({
  selector: 'app-travel-print-quo',
  templateUrl: './travel-print-quo.component.html',
  styleUrls: ['./travel-print-quo.component.scss'],
})
export class TravelPrintQuoComponent implements OnInit {
