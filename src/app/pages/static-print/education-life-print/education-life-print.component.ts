...
@Component({
  ...
  templateUrl: './education-life-print.component.html',
  styleUrls: ['./education-life-print.component.scss']
})
export class EducationLifePrintComponent implements OnInit {
