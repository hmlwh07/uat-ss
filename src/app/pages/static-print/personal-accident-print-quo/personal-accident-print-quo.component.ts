...
@Component({
  selector: 'app-personal-accident-print-quo',
  templateUrl: './personal-accident-print-quo.component.html',
  styleUrls: ['./personal-accident-print-quo.component.scss'],
})
export class PersonalAccidentPrintQuoComponent implements OnInit {
