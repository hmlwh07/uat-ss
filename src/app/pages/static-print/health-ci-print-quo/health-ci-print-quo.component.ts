...
@Component({
  selector: 'app-health-ci-print-quo',
  templateUrl: './health-ci-print-quo.component.html',
  styleUrls: ['./health-ci-print-quo.component.scss'],
})
export class HealthCiPrintQuoComponent implements OnInit {
