...
@Component({
  selector: 'app-fire-addon-page',
  templateUrl: './fire-addon-page.component.html',
  styleUrls: ['./fire-addon-page.component.scss']
})
export class FireAddonPageComponent implements OnInit {
  ...
  addOnsList: any[] = [
    ...
    {
      description: "Roit,Strike and Malicious Damage",
      code: "FA-002",
      option: "",
      premium: 20000
    },
    {
      description: "Storm,Typhoon,Hurricane,Tempest,Cyclone Burglary",
      code: "FA-003",
      option: "",
      premium: 20000
    }
