...
const API_ADDON_URL = `${environment.apiUrl}/report/weeklySalesAnalysis`;
...
export class ReportWeeklySalesAnalysisBranchExportService extends BizOperationService<any, number>{
