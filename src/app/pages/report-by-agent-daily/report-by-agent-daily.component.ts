...
import { ReportAgentDailyExportService } from './report-by-agent-daily-export.service';
import { CONSTANT_AGENT_REPORT_DATA } from './report-by-agent-daily.const';

@Component({
  selector: 'app-report-by-agent-daily',
  templateUrl: './report-by-agent-daily.component.html',
  styleUrls: ['./report-by-agent-daily.component.scss']
})
export class ReportByAgentDailyComponent implements OnInit {
